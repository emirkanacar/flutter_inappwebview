...
| --- | --- | ---: | --- |
| Locally implemented or mitigated; runtime validation pending | Issue register below | 63 | Source, regression, and host/build checks pass; real validation remains. |
...
| Open implementation or reproduction | [open work plan](open-work-plan.md) | 61 | No complete local implementation boundary has been established. |
...
| Unlabelled | 8 | 7 | 0 | 1 | 1 |
| Showcase | 3 | 0 | 0 | 3 | 0 |
| **Total** | **125** | **63** | **1** | **61** | **58** |

## Issue register

The following 63 issue records have moved out of the active implementation
...
`#2791`, `#2797`, `#2805`, `#2812`, `#2813`, `#2814`, `#2819`, `#2831`,
