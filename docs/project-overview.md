...
| --- | --- | ---: | --- | --- |
| `flutter_inappwebview_forge` | Shared Dart API and example | 2.1.0 | 3.38.6 | Public controllers, widgets, settings, callbacks |
...
| `flutter_inappwebview_forge_macos` | `WKWebView`, Swift, SPM/CocoaPods | 1.1.0 | 3.32.0 | macOS WebKit and browser windows |
