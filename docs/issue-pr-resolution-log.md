...
| --- | ---: | --- |
| Locally implemented or mitigated; runtime validation pending | 70 issues | [runtime-validation-pending.md](runtime-validation-pending.md) |
...
| Open implementation or reproduction | 39 issues | [open-work-plan.md](open-work-plan.md) |
