...
| --- | ---: | --- |
| Locally implemented or mitigated; runtime validation pending | 64 issues | [runtime-validation-pending.md](runtime-validation-pending.md) |
| Closed by source review | 1 issue (`#2745`) | No package runtime gate |
| Open implementation or reproduction | 60 issues | [open-work-plan.md](open-work-plan.md) |
