...
| 2.1.0 | iOS 26 fullscreen video [#2710](https://github.com/pichillilorenzo/flutter_inappwebview/issues/2710) | No direct PR relationship was present in the export | The same `WKWebView` is moved into a native fullscreen container after the affected seek/time-change path. This is a targeted WebKit mitigation and still needs device validation. |
