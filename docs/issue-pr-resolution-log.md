...
| 2026-08-08 | iOS location prompt source review [#2831](https://github.com/pichillilorenzo/flutter_inappwebview/issues/2831) | No upstream relationship inferred | The reported geolocation callback is Android-only and no iOS native geolocation delegate or plugin-owned presenter exists in this repository. Existing scene-aware presenter guards remain; iOS 26 device reproduction is the only remaining work before a permission-code change. |
...
| 2026-08-08 | Android Chrome callback ownership [#2697](https://github.com/pichillilorenzo/flutter_inappwebview/issues/2697); iOS WebMessageChannel payloads [#2584](https://github.com/pichillilorenzo/flutter_inappwebview/issues/2584) | No upstream relationship inferred | Android Chrome callbacks now reject unrelated WebViews safely. iOS WebMessageChannel indices and payloads are validated before access. Android tests and the iOS source test pass with Flutter 3.44.8; iOS runtime validation remains pending. |
