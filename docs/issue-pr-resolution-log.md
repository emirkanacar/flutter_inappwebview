...
| --- | ---: | --- |
| Locally implemented or mitigated; runtime validation pending | 72 issues | [runtime-validation-pending.md](runtime-validation-pending.md) |
...
| Open implementation or reproduction | 37 issues | [open-work-plan.md](open-work-plan.md) |
