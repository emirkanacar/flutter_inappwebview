...
| Host/platform-specific boundary | 7 issues (`#2570`, `#2598`, `#2636`, `#2659`, `#2713`, `#2723`, `#2727`) | Host/provider/engine/application/site tracking in [known-issues.md](known-issues.md); no Forge-owned fix |
| Open implementation or reproduction | 51 issues | [open-work-plan.md](open-work-plan.md) |
