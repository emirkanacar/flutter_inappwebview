...
| Host/platform-specific boundary | 3 issues (`#2636`, `#2659`, `#2727`) | Host/provider/engine tracking in [known-issues.md](known-issues.md); no Forge-owned fix |
| Open implementation or reproduction | 55 issues | [open-work-plan.md](open-work-plan.md) |
