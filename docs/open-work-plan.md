...
The export contains 125 issues and 73 PRs. Forty issue records have a documented local implementation or mitigation boundary; the remainder stay in the backlog until runtime evidence is available. Three additional PR-only records (`#2771`, `#2871`, and `#2474`) are implemented locally; they are tracked separately and do not change the issue counts below. The remaining issue records are:

| Category | Count | Treatment |
| --- | ---: | --- |
| Bugs | 70 | Technical work, validation, or reproduction required |
...
| **Total remaining issue records** | **85** | **82 technical issue records after excluding showcase entries** |
...
- **Plan gate:** keep an issue in this plan until the team has enough evidence to genuinely call it resolved; record source-only progress in `known-issues.md` without removing the unresolved work item.

## Already excluded from this plan

These issue records are not open implementation tasks only when the local code path and acceptance evidence are complete: `#2873`, `#2875`, `#2856`, `#2878`, `#2819`, `#2880`, `#2762`, `#2868`, `#2872`, `#2849`, `#2843`, `#2848`, `#2700`, `#2580`, `#2718`, `#2555`, `#2791`, `#2728`, `#2703`, `#2859`, `#2737`, `#2789`, `#2780`, `#2867`, `#2840`, `#2733`, `#2862`, `#2710`, `#2842`, `#2841`, `#2850`, `#2863`, `#2835`, `#2812`, `#2813`, `#2725`, `#2741`, `#2852`, `#2837`, `#2855`, and `#2745`. The later source-only mitigations remain listed in the validation matrix and are not subtracted from the issue export counts.
...
| --- | --- | --- | --- |
| [#2831](https://github.com/pichillilorenzo/flutter_inappwebview/issues/2831) | iOS 26 location prompt cannot close | Exercise a minimal geolocation page against the iOS 26 `WKUIDelegate` decision bridge with scene transitions, popup presentation, and dismissal. | The Dart callback reaches WebKit's decision handler exactly once for grant/deny, iOS 15-25 behavior is unchanged, and physical iOS 26 runtime evidence is recorded before removing this plan gate. |

Local source work exists for [#2861](https://github.com/pichillilorenzo/flutter_inappwebview/issues/2861) (Linux software-buffer fallback), [#2763](https://github.com/pichillilorenzo/flutter_inappwebview/issues/2763) (iOS rejected popup navigation), [#2536](https://github.com/pichillilorenzo/flutter_inappwebview/issues/2536) (Android Bundle extras), and [#2831](https://github.com/pichillilorenzo/flutter_inappwebview/issues/2831) (iOS 26 geolocation decision bridge), but these records remain validation-only until their target runtime, provider, restore, scene, and malformed-input evidence is recorded. [#2745](https://github.com/pichillilorenzo/flutter_inappwebview/issues/2745) is excluded after source review found no plugin-owned security sink. [#2831](https://github.com/pichillilorenzo/flutter_inappwebview/issues/2831) remains a P0 validation gate rather than an unrooted reproduction task.
...
| --- | --- | --- |
| Android | [#2873](https://github.com/pichillilorenzo/flutter_inappwebview/issues/2873), [#2875](https://github.com/pichillilorenzo/flutter_inappwebview/issues/2875), [#2878](https://github.com/pichillilorenzo/flutter_inappwebview/issues/2878), [#2819](https://github.com/pichillilorenzo/flutter_inappwebview/issues/2819), [#2849](https://github.com/pichillilorenzo/flutter_inappwebview/issues/2849), [#2843](https://github.com/pichillilorenzo/flutter_inappwebview/issues/2843), [#2580](https://github.com/pichillilorenzo/flutter_inappwebview/issues/2580), [#2718](https://github.com/pichillilorenzo/flutter_inappwebview/issues/2718), [#2555](https://github.com/pichillilorenzo/flutter_inappwebview/issues/2555), [#2791](https://github.com/pichillilorenzo/flutter_inappwebview/issues/2791), [#2728](https://github.com/pichillilorenzo/flutter_inappwebview/issues/2728), [#2703](https://github.com/pichillilorenzo/flutter_inappwebview/issues/2703), [#2698](https://github.com/pichillilorenzo/flutter_inappwebview/issues/2698), [#2673](https://github.com/pichillilorenzo/flutter_inappwebview/issues/2673), [#2594](https://github.com/pichillilorenzo/flutter_inappwebview/issues/2594), [#2536](https://github.com/pichillilorenzo/flutter_inappwebview/issues/2536) | Real-device fullscreen/IME, cold-start AOT, interception timeout, cookies, Android 10 IME, provider cast payloads, Android 15/16 artifact, 16 KB APK/AAB, and InAppBrowser/Custom Tabs restore, rotation, provider, and malformed-extra evidence. |
| iOS/macOS | [#2880](https://github.com/pichillilorenzo/flutter_inappwebview/issues/2880), [#2762](https://github.com/pichillilorenzo/flutter_inappwebview/issues/2762), [#2859](https://github.com/pichillilorenzo/flutter_inappwebview/issues/2859), [#2867](https://github.com/pichillilorenzo/flutter_inappwebview/issues/2867), [#2710](https://github.com/pichillilorenzo/flutter_inappwebview/issues/2710), [#2707](https://github.com/pichillilorenzo/flutter_inappwebview/issues/2707), [#2763](https://github.com/pichillilorenzo/flutter_inappwebview/issues/2763), [#2831](https://github.com/pichillilorenzo/flutter_inappwebview/issues/2831) | Scene activation, iOS 15+ gestures/insets, popup JavaScript, rejected `onCreateWindow` navigation, iOS 26 fullscreen and geolocation grant/deny decisions, macOS browser-window teardown, and physical-device WebKit/AppKit evidence. |
| Windows/Linux | [#2840](https://github.com/pichillilorenzo/flutter_inappwebview/issues/2840), [#2733](https://github.com/pichillilorenzo/flutter_inappwebview/issues/2733), [#2789](https://github.com/pichillilorenzo/flutter_inappwebview/issues/2789), [#2780](https://github.com/pichillilorenzo/flutter_inappwebview/issues/2780), [#2862](https://github.com/pichillilorenzo/flutter_inappwebview/issues/2862), [#2872](https://github.com/pichillilorenzo/flutter_inappwebview/issues/2872), [#2861](https://github.com/pichillilorenzo/flutter_inappwebview/issues/2861) | Affected Windows create/destroy/exit matrix, WebView2 asset tree, minimized hit testing, WPE 2.0/1.x build matrix, Fedora/X11/Intel no-GL rendering, and Linux backend diagnostics. |
...
- Complete the Linux software-rendering runtime gate and retain the #2745 source-to-sink review as a closed-by-evidence record.
- Exercise the iOS 26 geolocation decision bridge and `onCreateWindow` behavior before removing their native validation gates.
...
The 2026-08-08 source-validation pass produced local mitigations for #2861, #2763, #2536, and #2831, but they are not treated as locally resolved until their device/provider/restore/runtime gates pass. The #2745 security claim is closed by source review because no plugin-owned remote-data sink was found. The plan deliberately keeps the export counts at 70 bugs, 10 enhancements, 2 unlabelled, and 3 showcase records; local implementation status is tracked separately in `known-issues.md` and the resolution log.
