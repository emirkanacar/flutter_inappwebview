...
remain in this active plan. Five additional PR-only records
(`#2243`, `#2771`, `#2871`, `#2474`, and `#2823`) are implemented locally and await
...
along with the five PR-only records. They are resolved implementation work,
...
items. The complete register contains 70 issue records and five PR-only
...
The 2026-08-12 status pass has 70 locally implemented or mitigated issue
...
#2698, #2713, #2723, #2727, #2753, #2796, and #2831), and 39 active issue records in this plan. The runtime-pending
