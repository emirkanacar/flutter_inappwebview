...
The export contains 125 issues and 73 PRs. Forty issue records are already resolved or mitigated locally and are documented in the [resolution log](issue-pr-resolution-log.md). The remaining issue records are:
...
| **Total remaining export records** | **85** | **82 technical records after excluding showcase entries** |
