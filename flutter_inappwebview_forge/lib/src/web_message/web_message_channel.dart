...
///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebMessageChannel}
///
...
class WebMessageChannel {
  ...
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebMessageChannel.isPropertySupported}
  ...
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebMessageChannel.isMethodSupported}
  ...
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebMessageChannel.id}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebMessageChannel.id.supported_platforms}
  String get id => platform.id;

  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebMessageChannel.port1}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebMessageChannel.port1.supported_platforms}
  WebMessagePort get port1 =>
      WebMessagePort.fromPlatform(platform: platform.port1);

  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebMessageChannel.port2}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebMessageChannel.port2.supported_platforms}
  WebMessagePort get port2 =>
      WebMessagePort.fromPlatform(platform: platform.port2);

  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebMessageChannel.dispose}
  ///
