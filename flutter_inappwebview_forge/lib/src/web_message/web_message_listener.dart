...
///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebMessageListener}
///
...
class WebMessageListener {
  ...
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebMessageListener.isPropertySupported}
  ...
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebMessageListener.isMethodSupported}
  ...
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebMessageListener.jsObjectName}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebMessageListener.jsObjectName.supported_platforms}
  String get jsObjectName => platform.jsObjectName;

  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebMessageListener.allowedOriginRules}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebMessageListener.allowedOriginRules.supported_platforms}
  Set<String>? get allowedOriginRules => platform.allowedOriginRules;

  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebMessageListener.onPostMessage}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebMessageListener.onPostMessage.supported_platforms}
  OnPostMessageCallback? get onPostMessage => platform.onPostMessage;

  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebMessageListener.dispose}
  ///
...
///{@macro flutter_inappwebview_forge_platform_interface.PlatformJavaScriptReplyProxy}
///
...
class JavaScriptReplyProxy {
  ...
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformJavaScriptReplyProxy.postMessage}
  ///
