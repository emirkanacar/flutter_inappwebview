# WPE WebKit Backend for flutter_inappwebview_forge_linux
...
```
-- flutter_inappwebview_forge_linux: Using WPE WebKit backend
-- flutter_inappwebview_forge_linux: Found wpe-webkit-2.0 (2.50.4)
-- flutter_inappwebview_forge_linux: Found wpe-platform-2.0 (WPEPlatform API - DEFAULT)
-- flutter_inappwebview_forge_linux: Found wpe-platform-headless-2.0
-- flutter_inappwebview_forge_linux: Will bundle /usr/local/lib/libWPEWebKit-2.0.so.1.6.9
-- flutter_inappwebview_forge_linux: Will bundle /usr/local/lib/libwpe-1.0.so.1.10.0
```
...
-- flutter_inappwebview_forge_linux: Using WPE WebKit backend
-- flutter_inappwebview_forge_linux: Found wpe-webkit-2.0 (2.50.4)
-- flutter_inappwebview_forge_linux: Found wpebackend-fdo-1.0 (Legacy FDO API)
-- flutter_inappwebview_forge_linux: Will bundle /usr/local/lib/libWPEWebKit-2.0.so.1.6.9
-- flutter_inappwebview_forge_linux: Will bundle /usr/local/lib/libwpe-1.0.so.1.10.0
-- flutter_inappwebview_forge_linux: Will bundle /usr/local/lib/.../libWPEBackend-fdo-1.0.so.1.11.0
```
