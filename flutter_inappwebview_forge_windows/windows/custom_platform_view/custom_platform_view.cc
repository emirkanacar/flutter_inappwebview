...
namespace flutter_inappwebview_plugin
{
    ...
    : hwnd_(hwnd), view(std::move(webView)), texture_registrar_(texture_registrar)
  {
    ...
    const auto method_channel_name = "com.emirkanacar/custom_platform_view_" + std::to_string(texture_id_);
    method_channel_ =
    ...
    const auto event_channel_name = "com.emirkanacar/custom_platform_view_" + std::to_string(texture_id_) + "_events";
    event_channel_ =
