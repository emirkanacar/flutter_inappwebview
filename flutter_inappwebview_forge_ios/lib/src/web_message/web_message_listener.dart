...
class IOSWebMessageListener extends PlatformWebMessageListener
  ...
  IOSWebMessageListener(PlatformWebMessageListenerCreationParams params)
    ...
    channel = MethodChannel(
      'com.emirkanacar/flutter_inappwebview_web_message_listener_${_id}_${params.jsObjectName}',
    );
...
///{@macro flutter_inappwebview_forge_platform_interface.JavaScriptReplyProxy}
