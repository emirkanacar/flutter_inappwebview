...
void main() {
  ...
  test('nullable Android event fields do not abort the event dispatcher', () async {
    ...
    await controller.handler!(
      const MethodCall('onGeolocationPermissionsShowPrompt', {'origin': null}),
    );
    await controller.handler!(
      const MethodCall('onSafeBrowsingHit', {
        'url': null,
        'threatType': 0,
      }),
    );
