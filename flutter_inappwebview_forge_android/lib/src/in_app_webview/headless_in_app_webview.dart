...
class AndroidHeadlessInAppWebViewCreationParams
  ...
  AndroidHeadlessInAppWebViewCreationParams.fromPlatformHeadlessInAppWebViewCreationParams(
    PlatformHeadlessInAppWebViewCreationParams params,
        ...
        onVisualStateReady: params.onVisualStateReady,
        onWritingToolsActiveChanged: params.onWritingToolsActiveChanged,
        onWebViewNavigation: params.onWebViewNavigation,
...
class AndroidHeadlessInAppWebView extends PlatformHeadlessInAppWebView
  ...
  static const MethodChannel _sharedChannel = const MethodChannel(
    'com.emirkanacar/flutter_headless_inappwebview',
  );
  ...
  _init() {
    ...
    channel = MethodChannel(
      'com.emirkanacar/flutter_headless_inappwebview_$id',
    );
