...
class AndroidInAppWebViewController extends PlatformInAppWebViewController
  ...
  AndroidInAppWebViewController(
    ...
    channel = MethodChannel('com.emirkanacar/flutter_inappwebview_$id');
...
""",
  ...
  Future<void> setBackgroundColor(Color color) async {
    final args = <String, dynamic>{'color': color.toHex()};
...
(function() {
  ...
  Future<String> get tRexRunnerHtml async => await rootBundle.loadString(
    'packages/flutter_inappwebview_forge/assets/t_rex_runner/t-rex.html',
  );

  @override
  Future<String> get tRexRunnerCss async => await rootBundle.loadString(
    'packages/flutter_inappwebview_forge/assets/t_rex_runner/t-rex.css',
  );
