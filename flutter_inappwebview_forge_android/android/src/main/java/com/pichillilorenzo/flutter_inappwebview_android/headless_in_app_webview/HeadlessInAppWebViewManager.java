...
public class HeadlessInAppWebViewManager extends ChannelDelegateImpl {
  ...
  public static final String METHOD_CHANNEL_NAME = "com.emirkanacar/flutter_headless_inappwebview";
  ...
  public void run(String id, HashMap<String, Object> params) {
    ...
    boolean deferNativeOperationsUntilAttach = plugin.activity != null;
    FlutterWebView flutterWebView = new FlutterWebView(plugin, context, id, params, deferNativeOperationsUntilAttach);
