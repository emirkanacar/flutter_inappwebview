...
class InterceptFetchRequestJS private constructor() {
  companion object {

  @JvmField
  val INTERCEPT_FETCH_REQUEST_JS_PLUGIN_SCRIPT_GROUP_NAME = "IN_APP_WEBVIEW_INTERCEPT_FETCH_REQUEST_JS_PLUGIN_SCRIPT"

  @JvmStatic
  fun FLAG_VARIABLE_FOR_SHOULD_INTERCEPT_FETCH_REQUEST_JS_SOURCE(): String {
    return JavaScriptBridgeJS.get_JAVASCRIPT_BRIDGE_NAME() + "._useShouldInterceptFetchRequest";
  }

  @JvmStatic
  fun INTERCEPT_FETCH_REQUEST_JS_PLUGIN_SCRIPT(allowedOriginRules: MutableSet<String>?,
  ...
  @JvmStatic
  fun INTERCEPT_FETCH_REQUEST_JS_SOURCE(): String {
