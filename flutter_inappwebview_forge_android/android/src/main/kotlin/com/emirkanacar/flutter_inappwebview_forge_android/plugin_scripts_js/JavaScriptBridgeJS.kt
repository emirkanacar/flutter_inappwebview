...
class JavaScriptBridgeJS private constructor() {
  companion object {
  private var _JAVASCRIPT_BRIDGE_NAME = "flutter_inappwebview"

  @JvmStatic
  fun set_JAVASCRIPT_BRIDGE_NAME(bridgeName: String) {
    _JAVASCRIPT_BRIDGE_NAME = bridgeName;
  }

  @JvmStatic
  fun get_JAVASCRIPT_BRIDGE_NAME(): String {
    return _JAVASCRIPT_BRIDGE_NAME;
  }

  @JvmField
  val JAVASCRIPT_BRIDGE_JS_PLUGIN_SCRIPT_GROUP_NAME = "IN_APP_WEBVIEW_JAVASCRIPT_BRIDGE_JS_PLUGIN_SCRIPT"

  private const val VAR_JAVASCRIPT_BRIDGE_BRIDGE_SECRET = "\$IN_APP_WEBVIEW_JAVASCRIPT_BRIDGE_BRIDGE_SECRET"

  @JvmStatic
  fun JAVASCRIPT_BRIDGE_JS_PLUGIN_SCRIPT(expectedBridgeSecret: String,
                                         allowedOriginRules: MutableSet<String>?,
                                         forMainFrameOnly: Boolean): PluginScript {
    val source = Util.replaceAll(JavaScriptBridgeJS.JAVASCRIPT_BRIDGE_JS_SOURCE(), VAR_JAVASCRIPT_BRIDGE_BRIDGE_SECRET, expectedBridgeSecret);
    return PluginScript(
  ...
  @JvmStatic
  fun JAVASCRIPT_BRIDGE_JS_SOURCE(): String {
  ...
  @JvmStatic
  fun PLATFORM_READY_JS_SOURCE(): String {
    return "(function() {" +
