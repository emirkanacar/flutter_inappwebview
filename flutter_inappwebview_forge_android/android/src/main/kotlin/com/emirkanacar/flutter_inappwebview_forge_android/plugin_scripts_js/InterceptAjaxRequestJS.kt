...
class InterceptAjaxRequestJS private constructor() {
  companion object {

  @JvmField
  val INTERCEPT_AJAX_REQUEST_JS_PLUGIN_SCRIPT_GROUP_NAME = "IN_APP_WEBVIEW_INTERCEPT_AJAX_REQUEST_JS_PLUGIN_SCRIPT"

  @JvmStatic
  fun FLAG_VARIABLE_FOR_SHOULD_INTERCEPT_AJAX_REQUEST_JS_SOURCE(): String {
    return JavaScriptBridgeJS.get_JAVASCRIPT_BRIDGE_NAME() + "._useShouldInterceptAjaxRequest";
  }

  @JvmStatic
  fun FLAG_VARIABLE_FOR_ON_AJAX_READY_STATE_CHANGE(): String {
    return JavaScriptBridgeJS.get_JAVASCRIPT_BRIDGE_NAME() + "._useOnAjaxReadyStateChange";
  }

  @JvmStatic
  fun FLAG_VARIABLE_FOR_ON_AJAX_PROGRESS(): String {
    return JavaScriptBridgeJS.get_JAVASCRIPT_BRIDGE_NAME() + "._useOnAjaxProgress";
  }

  @JvmStatic
  fun FLAG_VARIABLE_FOR_INTERCEPT_ONLY_ASYNC_AJAX_REQUESTS_JS_SOURCE(): String {
    return JavaScriptBridgeJS.get_JAVASCRIPT_BRIDGE_NAME() + "._interceptOnlyAsyncAjaxRequests";
  }

  @JvmStatic
  fun INTERCEPT_AJAX_REQUEST_JS_PLUGIN_SCRIPT(allowedOriginRules: MutableSet<String>?,
                                               forMainFrameOnly: Boolean,
                                               initialUseOnAjaxReadyStateChange: Boolean,
                                               initialUseOnAjaxProgress: Boolean): PluginScript {
    return PluginScript(
  ...
  @JvmStatic
  fun createInterceptOnlyAsyncAjaxRequestsPluginScript(onlyAsync: Boolean): PluginScript {
    return PluginScript(
            InterceptAjaxRequestJS.INTERCEPT_AJAX_REQUEST_JS_PLUGIN_SCRIPT_GROUP_NAME,
  ...
  @JvmStatic
  fun INTERCEPT_AJAX_REQUEST_JS_SOURCE(initialUseOnAjaxReadyStateChange: Boolean,
                                        initialUseOnAjaxProgress: Boolean): String {
