...
open class JsBeforeUnloadResponse(
    ...
    companion object {
        @JvmStatic
        fun fromMap(map: MutableMap<String, Any?>?): JsBeforeUnloadResponse? {
            if (map == null) return null

            val message = map["message"] as? String
                ?: throw IllegalArgumentException("beforeunload message is required.")
            val confirmButtonTitle = map["confirmButtonTitle"] as? String
                ?: throw IllegalArgumentException("beforeunload confirmButtonTitle is required.")
            val cancelButtonTitle = map["cancelButtonTitle"] as? String
                ?: throw IllegalArgumentException("beforeunload cancelButtonTitle is required.")
            val handledByClient = map["handledByClient"] as? Boolean
                ?: throw IllegalArgumentException("beforeunload handledByClient is required.")
