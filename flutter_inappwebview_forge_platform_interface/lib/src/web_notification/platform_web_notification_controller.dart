...
///{@template flutter_inappwebview_forge_platform_interface.PlatformWebNotificationControllerCreationParams}
...
///{@endtemplate}
///
///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebNotificationControllerCreationParams.supported_platforms}
...
class PlatformWebNotificationControllerCreationParams {
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebNotificationControllerCreationParams.id}
  ///Web notification ID.
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebNotificationControllerCreationParams.id.supported_platforms}
  @SupportedPlatforms(platforms: [WindowsPlatform()])
  final String id;

  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebNotificationControllerCreationParams.notification}
  ///The notification data.
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebNotificationControllerCreationParams.notification.supported_platforms}
  @SupportedPlatforms(platforms: [WindowsPlatform()])
  final WebNotification notification;

  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebNotificationControllerCreationParams.isClassSupported}
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebNotificationControllerCreationParams.isPropertySupported}
...
///{@template flutter_inappwebview_forge_platform_interface.PlatformWebNotificationController}
...
///{@endtemplate}
///
///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebNotificationController.supported_platforms}
@SupportedPlatforms(platforms: [WindowsPlatform()])
abstract class PlatformWebNotificationController extends PlatformInterface
  ...
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebNotificationControllerCreationParams.id}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebNotificationControllerCreationParams.id.supported_platforms}
  String get id => params.id;

  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebNotificationControllerCreationParams.notification}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebNotificationControllerCreationParams.notification.supported_platforms}
  WebNotification get notification => params.notification;

  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebNotificationController.onClose}
  ...
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebNotificationController.onClose.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      WindowsPlatform(
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebNotificationController.reportShown}
  ...
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebNotificationController.reportShown.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      WindowsPlatform(
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebNotificationController.reportClicked}
  ...
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebNotificationController.reportClicked.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      WindowsPlatform(
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebNotificationController.reportClosed}
  ...
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebNotificationController.reportClosed.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      WindowsPlatform(
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebNotificationController.dispose}
  ///Disposes the web notification controller.
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebNotificationController.dispose.supported_platforms}
  @SupportedPlatforms(platforms: [WindowsPlatform()])
  @override
  void dispose() {
    throw UnimplementedError(
  ...
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebNotificationControllerCreationParams.isClassSupported}
  bool isClassSupported({TargetPlatform? platform}) =>
      params.isClassSupported(platform: platform);

  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebNotificationController.isPropertySupported}
  ///Check if the given [property] is supported by the [defaultTargetPlatform] or a specific [platform].
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebNotificationController.isMethodSupported}
