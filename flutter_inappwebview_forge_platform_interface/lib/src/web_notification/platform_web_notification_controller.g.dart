...
extension _PlatformWebNotificationControllerCreationParamsClassSupported
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebNotificationControllerCreationParams.supported_platforms}
  ///
...
enum PlatformWebNotificationControllerCreationParamsProperty {
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebNotificationControllerCreationParams.id.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- Windows WebView2
  ///
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebNotificationControllerCreationParams.notification.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- Windows WebView2
  ///
...
extension _PlatformWebNotificationControllerClassSupported
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebNotificationController.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- Windows WebView2
  ///
...
enum PlatformWebNotificationControllerProperty {
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebNotificationController.onClose.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
...
enum PlatformWebNotificationControllerMethod {
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebNotificationController.dispose.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- Windows WebView2
  ///
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebNotificationController.reportClicked.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebNotificationController.reportClosed.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebNotificationController.reportShown.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
