...
extension _PlatformWebMessageChannelCreationParamsClassSupported
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebMessageChannelCreationParams.supported_platforms}
  ///
...
enum PlatformWebMessageChannelCreationParamsProperty {
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebMessageChannelCreationParams.id.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- Android WebView
  ///- iOS WKWebView
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebMessageChannelCreationParams.port1.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- Android WebView
  ///- iOS WKWebView
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebMessageChannelCreationParams.port2.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- Android WebView
  ///- iOS WKWebView
...
extension _PlatformWebMessageChannelClassSupported
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebMessageChannel.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- Android WebView
  ///- iOS WKWebView
...
enum PlatformWebMessageChannelMethod {
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebMessageChannel.dispose.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- Android WebView
  ///- iOS WKWebView
