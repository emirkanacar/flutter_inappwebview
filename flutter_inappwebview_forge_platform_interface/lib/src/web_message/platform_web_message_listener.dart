...
///{@template flutter_inappwebview_forge_platform_interface.PlatformWebMessageListenerCreationParams}
...
///{@endtemplate}
///
///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebMessageListenerCreationParams.supported_platforms}
@SupportedPlatforms(
  platforms: [
    AndroidPlatform(),
    IOSPlatform(),
...
class PlatformWebMessageListenerCreationParams {
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebMessageListenerCreationParams.jsObjectName}
  ///The name for the injected JavaScript object.
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebMessageListenerCreationParams.jsObjectName.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(),
      IOSPlatform(),
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebMessageListenerCreationParams.allowedOriginRules}
  ///A set of matching rules for the allowed origins.
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebMessageListenerCreationParams.allowedOriginRules.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(),
      IOSPlatform(),
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebMessageListenerCreationParams.onPostMessage}
  ...
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebMessageListenerCreationParams.onPostMessage.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebMessageListenerCreationParams.isClassSupported}
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebMessageListenerCreationParams.isPropertySupported}
...
///{@template flutter_inappwebview_forge_platform_interface.PlatformWebMessageListener}
...
///{@endtemplate}
///
///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebMessageListener.supported_platforms}
@SupportedPlatforms(
  platforms: [
    AndroidPlatform(),
    IOSPlatform(),
...
abstract class PlatformWebMessageListener extends PlatformInterface
  ...
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebMessageListenerCreationParams.jsObjectName}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebMessageListenerCreationParams.jsObjectName.supported_platforms}
  String get jsObjectName => params.jsObjectName;

  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebMessageListenerCreationParams.allowedOriginRules}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebMessageListenerCreationParams.allowedOriginRules.supported_platforms}
  Set<String>? get allowedOriginRules => params.allowedOriginRules;

  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebMessageListenerCreationParams.onPostMessage}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebMessageListenerCreationParams.onPostMessage.supported_platforms}
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebMessageListener.dispose}
  ///Disposes the channel.
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebMessageListener.dispose.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(),
      IOSPlatform(),
  ...
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebMessageListenerCreationParams.isClassSupported}
  bool isClassSupported({TargetPlatform? platform}) =>
      _PlatformWebMessageListenerClassSupported.isClassSupported(
        platform: platform,
      );

  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebMessageListener.isPropertySupported}
  ///Check if the given [property] is supported by the [defaultTargetPlatform] or a specific [platform].
  ///{@endtemplate}
  bool isPropertySupported(
    PlatformWebMessageListenerCreationParamsProperty property, {
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebMessageListener.isMethodSupported}
...
///{@template flutter_inappwebview_forge_platform_interface.PlatformJavaScriptReplyProxy}
...
///{@endtemplate}
///
///{@macro flutter_inappwebview_forge_platform_interface.PlatformJavaScriptReplyProxy.supported_platforms}
@SupportedPlatforms(
  platforms: [
    AndroidPlatform(),
    IOSPlatform(),
...
abstract class PlatformJavaScriptReplyProxy extends PlatformInterface {
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformJavaScriptReplyProxy.postMessage}
  ...
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformJavaScriptReplyProxy.postMessage.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(),
      IOSPlatform(),
