...
///{@template flutter_inappwebview_forge_platform_interface.PlatformWebMessageChannelCreationParams}
...
///{@endtemplate}
///
///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebMessageChannelCreationParams.supported_platforms}
@SupportedPlatforms(
  platforms: [
    AndroidPlatform(),
    IOSPlatform(),
...
class PlatformWebMessageChannelCreationParams {
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebMessageChannelCreationParams.id}
  ///Message Channel ID used internally.
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebMessageChannelCreationParams.id.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(),
      IOSPlatform(),
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebMessageChannelCreationParams.port1}
  ///The first [PlatformWebMessagePort] object of the channel.
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebMessageChannelCreationParams.port1.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(),
      IOSPlatform(),
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebMessageChannelCreationParams.port2}
  ///The second [PlatformWebMessagePort] object of the channel.
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebMessageChannelCreationParams.port2.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(),
      IOSPlatform(),
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebMessageChannelCreationParams.isClassSupported}
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebMessageChannelCreationParams.isPropertySupported}
...
///{@template flutter_inappwebview_forge_platform_interface.PlatformWebMessageChannel}
...
///{@endtemplate}
///
///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebMessageChannel.supported_platforms}
@SupportedPlatforms(
  platforms: [
    AndroidPlatform(),
    IOSPlatform(),
...
abstract class PlatformWebMessageChannel extends PlatformInterface
  ...
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebMessageChannelCreationParams.id}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebMessageChannelCreationParams.id.supported_platforms}
  String get id => params.id;

  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebMessageChannelCreationParams.port1}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebMessageChannelCreationParams.port1.supported_platforms}
  PlatformWebMessagePort get port1 => params.port1;

  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebMessageChannelCreationParams.port2}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebMessageChannelCreationParams.port2.supported_platforms}
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebMessageChannel.dispose}
  ///Disposes the web message channel.
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebMessageChannel.dispose.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(),
      IOSPlatform(),
  ...
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebMessageChannelCreationParams.isClassSupported}
  bool isClassSupported({TargetPlatform? platform}) =>
      _PlatformWebMessageChannelClassSupported.isClassSupported(
        platform: platform,
      );

  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebMessageChannel.isPropertySupported}
  ///Check if the given [property] is supported by the [defaultTargetPlatform] or a specific [platform].
  ///{@endtemplate}
  bool isPropertySupported(
    PlatformWebMessageChannelCreationParamsProperty property, {
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebMessageChannel.isMethodSupported}
