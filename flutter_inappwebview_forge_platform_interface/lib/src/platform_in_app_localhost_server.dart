...
///{@template flutter_inappwebview_forge_platform_interface.PlatformInAppLocalhostServerCreationParams}
...
///{@endtemplate}
///
///{@macro flutter_inappwebview_forge_platform_interface.PlatformInAppLocalhostServerCreationParams.supported_platforms}
@SupportedPlatforms(
  platforms: [
    AndroidPlatform(),
    IOSPlatform(),
...
class PlatformInAppLocalhostServerCreationParams {
  ...
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformInAppLocalhostServer.port}
  final int port;

  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformInAppLocalhostServer.directoryIndex}
  final String directoryIndex;

  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformInAppLocalhostServer.documentRoot}
  final String documentRoot;

  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformInAppLocalhostServer.shared}
  final bool shared;
...
///{@template flutter_inappwebview_forge_platform_interface.PlatformInAppLocalhostServer}
...
///{@endtemplate}
///
///{@macro flutter_inappwebview_forge_platform_interface.PlatformInAppLocalhostServer.supported_platforms}
@SupportedPlatforms(
  platforms: [
    AndroidPlatform(),
    IOSPlatform(),
...
abstract class PlatformInAppLocalhostServer extends PlatformInterface {
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformInAppLocalhostServer.port}
  ///Represents the port of the server. The default value is `8080`.
  ///{@endtemplate}
  int get port => params.port;

  ///{@template flutter_inappwebview_forge_platform_interface.PlatformInAppLocalhostServer.directoryIndex}
  ///represents the index file to use. The default value is `index.html`.
  ///{@endtemplate}
  String get directoryIndex => params.directoryIndex;

  ///{@template flutter_inappwebview_forge_platform_interface.PlatformInAppLocalhostServer.documentRoot}
  ///Represents the document root path to serve. The default value is `./`.
  ///{@endtemplate}
  String get documentRoot => params.documentRoot;

  ///{@template flutter_inappwebview_forge_platform_interface.PlatformInAppLocalhostServer.shared}
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformInAppLocalhostServer.onData}
  ...
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformInAppLocalhostServer.start.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(),
      IOSPlatform(),
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformInAppLocalhostServer.close}
  ///Closes the server.
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformInAppLocalhostServer.close.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(),
      IOSPlatform(),
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformInAppLocalhostServer.isRunning}
  ///Indicates if the server is running or not.
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformInAppLocalhostServer.isRunning.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(),
      IOSPlatform(),
  ...
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformInAppLocalhostServerCreationParams.isClassSupported}
  bool isClassSupported({TargetPlatform? platform}) =>
      params.isClassSupported(platform: platform);

  ///{@template flutter_inappwebview_forge_platform_interface.PlatformInAppLocalhostServer.isMethodSupported}
