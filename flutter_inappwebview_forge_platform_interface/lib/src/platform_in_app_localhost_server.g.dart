...
extension _PlatformInAppLocalhostServerCreationParamsClassSupported
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformInAppLocalhostServerCreationParams.supported_platforms}
  ///
...
extension _PlatformInAppLocalhostServerClassSupported
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformInAppLocalhostServer.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- Android WebView
  ///- iOS WKWebView
...
enum PlatformInAppLocalhostServerMethod {
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformInAppLocalhostServer.close.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- Android WebView
  ///- iOS WKWebView
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformInAppLocalhostServer.isRunning.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- Android WebView
  ///- iOS WKWebView
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformInAppLocalhostServer.start.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- Android WebView
  ///- iOS WKWebView
