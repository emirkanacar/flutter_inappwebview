...
extension _PlatformWebAuthenticationSessionCreationParamsClassSupported
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebAuthenticationSessionCreationParams.supported_platforms}
  ///
...
extension _PlatformWebAuthenticationSessionClassSupported
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebAuthenticationSession.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- iOS WKWebView 11.0+
  ///- macOS WKWebView 10.15+
...
enum PlatformWebAuthenticationSessionProperty {
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebAuthenticationSession.callbackURLScheme.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- iOS WKWebView
  ///- macOS WKWebView
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebAuthenticationSession.id.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- iOS WKWebView
  ///- macOS WKWebView
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebAuthenticationSession.initialSettings.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- iOS WKWebView
  ///- macOS WKWebView
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebAuthenticationSession.onComplete.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- iOS WKWebView
  ///- macOS WKWebView
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebAuthenticationSession.url.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- iOS WKWebView
  ///- macOS WKWebView
...
enum PlatformWebAuthenticationSessionMethod {
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebAuthenticationSession.canStart.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebAuthenticationSession.cancel.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebAuthenticationSession.create.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- iOS WKWebView
  ///- macOS WKWebView
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebAuthenticationSession.dispose.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- iOS WKWebView
  ///- macOS WKWebView
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebAuthenticationSession.isAvailable.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- iOS WKWebView
  ///- macOS WKWebView
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebAuthenticationSession.start.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
