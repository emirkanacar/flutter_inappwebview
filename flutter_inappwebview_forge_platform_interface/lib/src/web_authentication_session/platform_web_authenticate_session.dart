...
///{@template flutter_inappwebview_forge_platform_interface.PlatformWebAuthenticationSessionCreationParams}
...
///{@endtemplate}
///
///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebAuthenticationSessionCreationParams.supported_platforms}
@SupportedPlatforms(
  platforms: [
...
class PlatformWebAuthenticationSessionCreationParams {
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebAuthenticationSessionCreationParams.isClassSupported}
  ///Check if the current class is supported by the [defaultTargetPlatform] or a specific [platform].
  ///{@endtemplate}
  bool isClassSupported({TargetPlatform? platform}) =>
      _PlatformWebAuthenticationSessionCreationParamsClassSupported.isClassSupported(
        platform: platform,
      );
}

///{@template flutter_inappwebview_forge_platform_interface.PlatformWebAuthenticationSession}
...
///{@endtemplate}
///
///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebAuthenticationSession.supported_platforms}
@SupportedPlatforms(
  platforms: [
    IOSPlatform(available: '11.0'),
    MacOSPlatform(available: '10.15'),
...
abstract class PlatformWebAuthenticationSession extends PlatformInterface
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebAuthenticationSession.id}
  ///ID used internally.
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebAuthenticationSession.id.supported_platforms}
  @SupportedPlatforms(platforms: [IOSPlatform(), MacOSPlatform()])
  String get id =>
      throw UnimplementedError('id is not implemented on the current platform');

  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebAuthenticationSession.url}
  ///A URL with the `http` or `https` scheme pointing to the authentication webpage.
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebAuthenticationSession.url.supported_platforms}
  @SupportedPlatforms(platforms: [IOSPlatform(), MacOSPlatform()])
  WebUri get url => throw UnimplementedError(
    'url is not implemented on the current platform',
  );

  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebAuthenticationSession.callbackURLScheme}
  ///The custom URL scheme that the app expects in the callback URL.
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebAuthenticationSession.callbackURLScheme.supported_platforms}
  @SupportedPlatforms(platforms: [IOSPlatform(), MacOSPlatform()])
  String? get callbackURLScheme => throw UnimplementedError(
    'callbackURLScheme is not implemented on the current platform',
  );

  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebAuthenticationSession.initialSettings}
  ///Initial settings.
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebAuthenticationSession.initialSettings.supported_platforms}
  @SupportedPlatforms(platforms: [IOSPlatform(), MacOSPlatform()])
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebAuthenticationSession.onComplete}
  ///A completion handler the session calls when it completes successfully, or when the user cancels the session.
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebAuthenticationSession.onComplete.supported_platforms}
  @SupportedPlatforms(platforms: [IOSPlatform(), MacOSPlatform()])
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebAuthenticationSession.create}
  ...
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebAuthenticationSession.create.supported_platforms}
  @SupportedPlatforms(platforms: [IOSPlatform(), MacOSPlatform()])
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebAuthenticationSession.canStart}
  ///Indicates whether the session can begin.
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebAuthenticationSession.canStart.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      IOSPlatform(
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebAuthenticationSession.start}
  ...
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebAuthenticationSession.start.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      IOSPlatform(
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebAuthenticationSession.cancel}
  ...
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebAuthenticationSession.cancel.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      IOSPlatform(
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebAuthenticationSession.dispose}
  ///Disposes the web authentication session.
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebAuthenticationSession.dispose.supported_platforms}
  @SupportedPlatforms(platforms: [IOSPlatform(), MacOSPlatform()])
  @override
  Future<void> dispose() {
    throw UnimplementedError(
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebAuthenticationSession.isAvailable}
  ...
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebAuthenticationSession.isAvailable.supported_platforms}
  @SupportedPlatforms(platforms: [IOSPlatform(), MacOSPlatform()])
  ...
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebAuthenticationSessionCreationParams.isClassSupported}
  bool isClassSupported({TargetPlatform? platform}) =>
      _PlatformWebAuthenticationSessionClassSupported.isClassSupported(
        platform: platform,
      );

  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebAuthenticationSession.isPropertySupported}
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebAuthenticationSession.isMethodSupported}
