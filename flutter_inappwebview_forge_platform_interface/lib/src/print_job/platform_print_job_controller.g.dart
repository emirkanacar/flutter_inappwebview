...
extension _PlatformPrintJobControllerCreationParamsClassSupported
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformPrintJobControllerCreationParams.supported_platforms}
  ///
...
enum PlatformPrintJobControllerCreationParamsProperty {
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformPrintJobControllerCreationParams.id.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- Android WebView
  ///- iOS WKWebView
...
extension _PlatformPrintJobControllerClassSupported
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformPrintJobController.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- Android WebView
  ///- iOS WKWebView
...
enum PlatformPrintJobControllerProperty {
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformPrintJobController.onComplete.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
...
enum PlatformPrintJobControllerMethod {
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformPrintJobController.cancel.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformPrintJobController.dismiss.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- iOS WKWebView
  ///
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformPrintJobController.dispose.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- Android WebView
  ///- iOS WKWebView
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformPrintJobController.getInfo.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformPrintJobController.restart.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
