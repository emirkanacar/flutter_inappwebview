...
import 'package:flutter_inappwebview_forge_platform_interface/src/types/disposable.dart';
...
/// this class.
///{@template flutter_inappwebview_forge_platform_interface.PlatformWebStorageCreationParams}
/// Object specifying creation parameters for creating a [PlatformWebStorage].
///
/// Platform specific implementations can add additional fields by extending
/// this class.
///{@endtemplate}
///
///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebStorageCreationParams.supported_platforms}
@SupportedPlatforms(
  platforms: [
    AndroidPlatform(),
    IOSPlatform(),
...
class PlatformWebStorageCreationParams {
  ...
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebStorage.localStorage}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebStorage.localStorage.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(),
      IOSPlatform(),
  ...
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebStorage.sessionStorage}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebStorage.sessionStorage.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(),
      IOSPlatform(),
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebStorageCreationParams.isClassSupported}
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebStorageCreationParams.isPropertySupported}
...
///{@template flutter_inappwebview_forge_platform_interface.PlatformWebStorage}
...
///{@endtemplate}
///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebStorage.supported_platforms}
@SupportedPlatforms(
  platforms: [
    AndroidPlatform(),
    IOSPlatform(),
...
abstract class PlatformWebStorage extends PlatformInterface
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebStorage.localStorage}
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebStorage.sessionStorage}
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebStorage.dispose}
  ///Disposes the web storage.
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebStorage.dispose.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(),
      IOSPlatform(),
  ...
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebStorageCreationParams.isClassSupported}
  bool isClassSupported({TargetPlatform? platform}) =>
      _PlatformWebStorageClassSupported.isClassSupported(platform: platform);

  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebStorage.isPropertySupported}
  ///Check if the given [property] is supported by the [defaultTargetPlatform] or a specific [platform].
  ///{@endtemplate}
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebStorage.isMethodSupported}
...
/// Platform specific implementations can add additional fields by extending
/// this class.
///{@template flutter_inappwebview_forge_platform_interface.PlatformStorageCreationParams}
/// Object specifying creation parameters for creating a [PlatformStorage].
///
/// Platform specific implementations can add additional fields by extending
/// this class.
///{@endtemplate}
///
///{@macro flutter_inappwebview_forge_platform_interface.PlatformStorageCreationParams.supported_platforms}
@SupportedPlatforms(
  platforms: [
    AndroidPlatform(),
    IOSPlatform(),
...
class PlatformStorageCreationParams {
  ...
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformStorage.controller}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformStorage.controller.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(),
      IOSPlatform(),
  ...
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformStorage.webStorageType}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformStorage.webStorageType.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(),
      IOSPlatform(),
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformStorageCreationParams.isClassSupported}
  ///Check if the current class is supported by the [defaultTargetPlatform] or a specific [platform].
  ///{@endtemplate}
  bool isClassSupported({TargetPlatform? platform}) =>
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformStorageCreationParams.isPropertySupported}
  ///Check if the given [property] is supported by the [defaultTargetPlatform] or a specific [platform].
  ///{@endtemplate}
  bool isPropertySupported(
...
///{@template flutter_inappwebview_forge_platform_interface.PlatformStorage}
...
///{@endtemplate}
///{@macro flutter_inappwebview_forge_platform_interface.PlatformStorage.supported_platforms}
@SupportedPlatforms(
  platforms: [
    AndroidPlatform(),
    IOSPlatform(),
...
abstract mixin class PlatformStorage implements Disposable {
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformStorage.controller}
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformStorage.webStorageType}
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformStorage.length}
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformStorage.setItem}
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformStorage.getItem}
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformStorage.removeItem}
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformStorage.getItems}
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformStorage.clear}
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformStorage.key}
...
class PlatformLocalStorageCreationParams extends PlatformStorageCreationParams {
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformLocalStorageCreationParams.isClassSupported}
  ///Check if the current class is supported by the [defaultTargetPlatform] or a specific [platform].
  ///{@endtemplate}
  bool isClassSupported({TargetPlatform? platform}) =>
...
///{@template flutter_inappwebview_forge_platform_interface.PlatformLocalStorage}
///Class that provides methods to manage the JavaScript `window.localStorage` object.
///It used by [PlatformWebStorage].
///{@endtemplate}
///{@macro flutter_inappwebview_forge_platform_interface.PlatformLocalStorage.supported_platforms}
@SupportedPlatforms(
  platforms: [
    AndroidPlatform(),
    IOSPlatform(),
...
abstract class PlatformLocalStorage extends PlatformInterface
  ...
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformLocalStorage.isClassSupported}
  bool isClassSupported({TargetPlatform? platform}) =>
      _PlatformLocalStorageClassSupported.isClassSupported(platform: platform);

  ///{@template flutter_inappwebview_forge_platform_interface.PlatformLocalStorage.isPropertySupported}
  ///Check if the given [property] is supported by the [defaultTargetPlatform] or a specific [platform].
  ///{@endtemplate}
  bool isPropertySupported(
    PlatformStorageCreationParamsProperty property, {
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformLocalStorage.isMethodSupported}
  ///Check if the given [method] is supported by the [defaultTargetPlatform] or a specific [platform].
  ///{@endtemplate}
  bool isMethodSupported(
...
class PlatformSessionStorageCreationParams
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformSessionStorageCreationParams.isClassSupported}
  ///Check if the current class is supported by the [defaultTargetPlatform] or a specific [platform].
  ///{@endtemplate}
  bool isClassSupported({TargetPlatform? platform}) =>
...
///{@template flutter_inappwebview_forge_platform_interface.PlatformSessionStorage}
///Class that provides methods to manage the JavaScript `window.sessionStorage` object.
///It used by [PlatformWebStorage].
///{@endtemplate}
///{@macro flutter_inappwebview_forge_platform_interface.PlatformSessionStorage.supported_platforms}
@SupportedPlatforms(
  platforms: [
    AndroidPlatform(),
    IOSPlatform(),
...
abstract class PlatformSessionStorage extends PlatformInterface
  ...
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformSessionStorage.isClassSupported}
  bool isClassSupported({TargetPlatform? platform}) =>
      _PlatformSessionStorageClassSupported.isClassSupported(
        platform: platform,
      );

  ///{@template flutter_inappwebview_forge_platform_interface.PlatformSessionStorage.isPropertySupported}
  ///Check if the given [property] is supported by the [defaultTargetPlatform] or a specific [platform].
  ///{@endtemplate}
  bool isPropertySupported(
    PlatformStorageCreationParamsProperty property, {
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformSessionStorage.isMethodSupported}
  ///Check if the given [method] is supported by the [defaultTargetPlatform] or a specific [platform].
  ///{@endtemplate}
  bool isMethodSupported(
