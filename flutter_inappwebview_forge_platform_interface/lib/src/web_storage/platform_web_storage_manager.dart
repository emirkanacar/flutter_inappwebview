...
///{@template flutter_inappwebview_forge_platform_interface.PlatformWebStorageManagerCreationParams}
...
///{@endtemplate}
///
///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebStorageManagerCreationParams.supported_platforms}
@SupportedPlatforms(
  platforms: [
    AndroidPlatform(),
...
class PlatformWebStorageManagerCreationParams {
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebStorageManagerCreationParams.isClassSupported}
...
///{@template flutter_inappwebview_forge_platform_interface.PlatformWebStorageManager}
///Class that implements a singleton object (shared instance) which manages the web storage used by WebView instances.
///{@endtemplate}
///
///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebStorageManager.supported_platforms}
@SupportedPlatforms(
  platforms: [
    AndroidPlatform(
      apiName: 'WebStorage',
...
abstract class PlatformWebStorageManager extends PlatformInterface {
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebStorageManager.getOrigins}
  ///Gets the origins currently using either the Application Cache or Web SQL Database APIs.
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebStorageManager.getOrigins.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebStorageManager.deleteAllData}
  ///Clears all storage currently being used by the JavaScript storage APIs.
  ///This includes the Application Cache, Web SQL Database and the HTML5 Web Storage APIs.
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebStorageManager.deleteAllData.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebStorageManager.deleteOrigin}
  ...
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebStorageManager.deleteOrigin.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebStorageManager.getQuotaForOrigin}
  ...
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebStorageManager.getQuotaForOrigin.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebStorageManager.getUsageForOrigin}
  ...
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebStorageManager.getUsageForOrigin.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebStorageManager.fetchDataRecords}
  ...
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebStorageManager.fetchDataRecords.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      IOSPlatform(
        available: '9.0',
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebStorageManager.removeDataFor}
  ...
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebStorageManager.removeDataFor.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      IOSPlatform(
        available: '9.0',
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebStorageManager.removeDataModifiedSince}
  ...
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebStorageManager.removeDataModifiedSince.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      IOSPlatform(
        available: '9.0',
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebStorageManager.isClassSupported}
  ///Check if the current class is supported by the [defaultTargetPlatform] or a specific [platform].
  ///{@endtemplate}
  bool isClassSupported({TargetPlatform? platform}) =>
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebStorageManager.isMethodSupported}
