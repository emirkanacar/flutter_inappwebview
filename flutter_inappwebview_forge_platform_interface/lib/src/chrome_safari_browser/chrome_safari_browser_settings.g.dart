...
///{@template flutter_inappwebview_forge_platform_interface.ChromeSafariBrowserSettings}
///Class that represents the settings that can be used for an [ChromeSafariBrowser] window.
///{@endtemplate}
///
///{@macro flutter_inappwebview_forge_platform_interface.ChromeSafariBrowserSettings.supported_platforms}
///
...
enum ChromeSafariBrowserSettingsProperty {
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.ChromeSafariBrowserSettings.activityButton.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- iOS SFSafariViewController 15.0+
  ///
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.ChromeSafariBrowserSettings.additionalTrustedOrigins.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- Android Chrome Custom Tabs:
  ///    - Not available in a Trusted Web Activity.
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.ChromeSafariBrowserSettings.alwaysUseBrowserUI.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- Android Chrome Custom Tabs
  ///
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.ChromeSafariBrowserSettings.barCollapsingEnabled.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- iOS SFSafariViewController
  ///
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.ChromeSafariBrowserSettings.dismissButtonStyle.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- iOS SFSafariViewController 11.0+
  ///
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.ChromeSafariBrowserSettings.displayMode.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- Android Chrome Custom Tabs:
  ///    - Not available in a Trusted Web Activity.
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.ChromeSafariBrowserSettings.enableUrlBarHiding.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- Android Chrome Custom Tabs:
  ///    - Not available in a Trusted Web Activity.
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.ChromeSafariBrowserSettings.entersReaderIfAvailable.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- iOS SFSafariViewController
  ///
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.ChromeSafariBrowserSettings.eventAttribution.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- iOS SFSafariViewController 15.2+
  ///
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.ChromeSafariBrowserSettings.exitAnimations.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- Android Chrome Custom Tabs
  ///
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.ChromeSafariBrowserSettings.instantAppsEnabled.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- Android Chrome Custom Tabs:
  ///    - Not available in a Trusted Web Activity.
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.ChromeSafariBrowserSettings.isSingleInstance.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- Android Chrome Custom Tabs
  ///
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.ChromeSafariBrowserSettings.isTrustedWebActivity.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- Android Chrome Custom Tabs
  ///
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.ChromeSafariBrowserSettings.keepAliveEnabled.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- Android Chrome Custom Tabs
  ///
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.ChromeSafariBrowserSettings.navigationBarColor.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- Android Chrome Custom Tabs
  ///
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.ChromeSafariBrowserSettings.navigationBarDividerColor.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- Android Chrome Custom Tabs
  ///
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.ChromeSafariBrowserSettings.noHistory.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- Android Chrome Custom Tabs
  ///
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.ChromeSafariBrowserSettings.packageName.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- Android Chrome Custom Tabs
  ///
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.ChromeSafariBrowserSettings.preferredBarTintColor.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- iOS SFSafariViewController 10.0+
  ///
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.ChromeSafariBrowserSettings.preferredControlTintColor.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- iOS SFSafariViewController 10.0+
  ///
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.ChromeSafariBrowserSettings.presentationStyle.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- iOS SFSafariViewController
  ///
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.ChromeSafariBrowserSettings.screenOrientation.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- Android Chrome Custom Tabs:
  ///    - Not available in a Trusted Web Activity.
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.ChromeSafariBrowserSettings.secondaryToolbarColor.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- Android Chrome Custom Tabs
  ///
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.ChromeSafariBrowserSettings.shareState.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- Android Chrome Custom Tabs:
  ///    - Not available in a Trusted Web Activity.
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.ChromeSafariBrowserSettings.showTitle.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- Android Chrome Custom Tabs:
  ///    - Not available in a Trusted Web Activity.
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.ChromeSafariBrowserSettings.startAnimations.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- Android Chrome Custom Tabs
  ///
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.ChromeSafariBrowserSettings.toolbarBackgroundColor.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- Android Chrome Custom Tabs
  ///
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.ChromeSafariBrowserSettings.transitionStyle.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- iOS SFSafariViewController
  ///
