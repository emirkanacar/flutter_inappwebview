...
extension _PlatformChromeSafariBrowserClassSupported
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowser.supported_platforms}
  ///
...
enum PlatformChromeSafariBrowserMethod {
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowser.addMenuItem.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- Android Chrome Custom Tabs:
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowser.addMenuItems.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- Android Chrome Custom Tabs:
  ///    - Not available in a Trusted Web Activity.
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowser.clearWebsiteData.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowser.close.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- Android Chrome Custom Tabs
  ///- iOS SFSafariViewController
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowser.dispose.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- Android Chrome Custom Tabs
  ///- iOS SFSafariViewController
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowser.getMaxToolbarItems.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- Android Chrome Custom Tabs
  ///
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowser.getPackageName.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowser.invalidatePrewarmingToken.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowser.isAvailable.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- Android Chrome Custom Tabs
  ///- iOS SFSafariViewController
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowser.isEngagementSignalsApiAvailable.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowser.isOpened.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- Android Chrome Custom Tabs
  ///- iOS SFSafariViewController
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowser.launchUrl.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- Android Chrome Custom Tabs
  ///
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowser.mayLaunchUrl.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowser.open.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- Android Chrome Custom Tabs
  ///- iOS SFSafariViewController
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowser.postMessage.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowser.prewarmConnections.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowser.requestPostMessageChannel.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowser.setActionButton.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowser.setSecondaryToolbar.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowser.updateActionButton.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- Android Chrome Custom Tabs ([Official API - CustomTabsSession.setActionButton](https://developer.android.com/reference/androidx/browser/customtabs/CustomTabsIntent.Builder#setActionButton(android.graphics.Bitmap,%20java.lang.String,%20android.app.PendingIntent,%20boolean))):
  ///    - Not available in a Trusted Web Activity.
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowser.updateSecondaryToolbar.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- Android Chrome Custom Tabs ([Official API - CustomTabsIntent.Builder.setSecondaryToolbarViews](https://developer.android.com/reference/androidx/browser/customtabs/CustomTabsIntent.Builder#setSecondaryToolbarViews(android.widget.RemoteViews,int[],android.app.PendingIntent))):
  ///    - Not available in a Trusted Web Activity.
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowser.validateRelationship.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
...
enum PlatformChromeSafariBrowserEventsMethod {
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowserEvents.onClosed.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- Android WebView
  ///- iOS WKWebView
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowserEvents.onCompletedInitialLoad.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- Android WebView
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowserEvents.onGreatestScrollPercentageIncreased.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowserEvents.onInitialLoadDidRedirect.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowserEvents.onMessageChannelReady.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowserEvents.onNavigationEvent.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowserEvents.onOpened.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- Android WebView
  ///- iOS WKWebView
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowserEvents.onPostMessage.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowserEvents.onRelationshipValidationResult.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowserEvents.onServiceConnected.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- Android WebView
  ///
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowserEvents.onSessionEnded.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowserEvents.onVerticalScrollEvent.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowserEvents.onWillOpenInBrowser.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
