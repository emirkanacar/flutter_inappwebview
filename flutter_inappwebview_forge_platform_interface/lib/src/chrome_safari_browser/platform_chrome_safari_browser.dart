...
///{@template flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowser}
...
///{@endtemplate}
///
///{@macro flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowser.supported_platforms}
@SupportedPlatforms(
  platforms: [
    AndroidPlatform(
      note:
...
abstract class PlatformChromeSafariBrowser extends PlatformInterface
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowser.id}
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowser.open}
  ...
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowser.open.supported_platforms}
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowser.launchUrl}
  ...
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowser.launchUrl.supported_platforms}
  @SupportedPlatforms(platforms: [AndroidPlatform()])
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowser.mayLaunchUrl}
  ...
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowser.mayLaunchUrl.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowser.validateRelationship}
  ...
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowser.validateRelationship.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowser.close}
  ///Closes the [PlatformChromeSafariBrowser] instance.
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowser.close.supported_platforms}
  @SupportedPlatforms(platforms: [AndroidPlatform(), IOSPlatform()])
  Future<void> close() {
    throw UnimplementedError(
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowser.setActionButton}
  ///Set a custom action button.
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowser.setActionButton.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowser.updateActionButton}
  ///Updates the [ChromeSafariBrowserActionButton.icon] and [ChromeSafariBrowserActionButton.description].
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowser.updateActionButton.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(
        apiName: 'CustomTabsSession.setActionButton',
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowser.setSecondaryToolbar}
  ///Sets the remote views displayed in the secondary toolbar in a custom tab.
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowser.setSecondaryToolbar.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowser.updateSecondaryToolbar}
  ///Sets or updates (if already present) the Remote Views of the secondary toolbar in an existing custom tab session.
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowser.updateSecondaryToolbar.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(
        apiName: 'CustomTabsIntent.Builder.setSecondaryToolbarViews',
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowser.addMenuItem}
  ///Adds a [ChromeSafariBrowserMenuItem] to the menu.
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowser.addMenuItem.supported_platforms}
  @SupportedPlatforms(
    platforms: [
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowser.addMenuItems}
  ///Adds a list of [ChromeSafariBrowserMenuItem] to the menu.
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowser.addMenuItems.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(note: 'Not available in a Trusted Web Activity.'),
      IOSPlatform(),
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowser.requestPostMessageChannel}
  ...
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowser.requestPostMessageChannel.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowser.postMessage}
  ...
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowser.postMessage.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowser.isEngagementSignalsApiAvailable}
  ...
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowser.isEngagementSignalsApiAvailable.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowser.isOpened}
  ///Returns `true` if the [PlatformChromeSafariBrowser] instance is opened, otherwise `false`.
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowser.isOpened.supported_platforms}
  @SupportedPlatforms(platforms: [AndroidPlatform(), IOSPlatform()])
  bool isOpened() {
    throw UnimplementedError(
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowser.isAvailable}
  ///On Android, returns `true` if Chrome Custom Tabs is available.
  ///On iOS, returns `true` if SFSafariViewController is available.
  ///Otherwise returns `false`.
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowser.isAvailable.supported_platforms}
  @SupportedPlatforms(platforms: [AndroidPlatform(), IOSPlatform()])
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowser.getMaxToolbarItems}
  ///The maximum number of allowed secondary toolbar items.
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowser.getMaxToolbarItems.supported_platforms}
  @SupportedPlatforms(platforms: [AndroidPlatform()])
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowser.getPackageName}
  ...
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowser.getPackageName.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowser.clearWebsiteData}
  ...
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowser.clearWebsiteData.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      IOSPlatform(
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowser.prewarmConnections}
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowser.invalidatePrewarmingToken}
  ///Ends all prewarmed connections associated with the token, except for connections that are also kept alive by other tokens.
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowser.invalidatePrewarmingToken.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      IOSPlatform(
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowser.dispose}
  ///Disposes the channel and event handler.
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowser.dispose.supported_platforms}
  @SupportedPlatforms(platforms: [AndroidPlatform(), IOSPlatform()])
  @override
  @mustCallSuper
  void dispose() {
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowser.isClassSupported}
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowser.isMethodSupported}
  ...
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowserEvents.isMethodSupported}
...
abstract class PlatformChromeSafariBrowserEvents {
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowserEvents.onServiceConnected}
  ///Event fired when the when connecting from Android Custom Tabs Service.
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowserEvents.onServiceConnected.supported_platforms}
  @SupportedPlatforms(platforms: [AndroidPlatform()])
  void onServiceConnected() {}

  ///{@template flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowserEvents.onOpened}
  ///Event fired when the [PlatformChromeSafariBrowser] is opened.
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowserEvents.onOpened.supported_platforms}
  @SupportedPlatforms(platforms: [AndroidPlatform(), IOSPlatform()])
  void onOpened() {}

  ///{@template flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowserEvents.onCompletedInitialLoad}
  ...
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowserEvents.onCompletedInitialLoad.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(),
      IOSPlatform(
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowserEvents.onInitialLoadDidRedirect}
  ///Event fired when the initial URL load is complete.
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowserEvents.onInitialLoadDidRedirect.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      IOSPlatform(
        apiName: 'SFSafariViewControllerDelegate.safariViewController',
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowserEvents.onNavigationEvent}
  ///Event fired when a navigation event happens.
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowserEvents.onNavigationEvent.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowserEvents.onRelationshipValidationResult}
  ...
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowserEvents.onRelationshipValidationResult.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowserEvents.onWillOpenInBrowser}
  ///Event fired when the user opens the current page in the default browser by tapping the toolbar button.
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowserEvents.onWillOpenInBrowser.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      IOSPlatform(
        apiName:
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowserEvents.onMessageChannelReady}
  ...
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowserEvents.onMessageChannelReady.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowserEvents.onPostMessage}
  ...
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowserEvents.onPostMessage.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowserEvents.onVerticalScrollEvent}
  ...
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowserEvents.onVerticalScrollEvent.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowserEvents.onGreatestScrollPercentageIncreased}
  ...
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowserEvents.onGreatestScrollPercentageIncreased.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(
        apiName:
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowserEvents.onSessionEnded}
  ...
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowserEvents.onSessionEnded.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowserEvents.onClosed}
  ///Event fired when the [PlatformChromeSafariBrowser] is closed.
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowserEvents.onClosed.supported_platforms}
  @SupportedPlatforms(platforms: [AndroidPlatform(), IOSPlatform()])
  void onClosed() {}

  ///{@template flutter_inappwebview_forge_platform_interface.PlatformChromeSafariBrowserEvents.isMethodSupported}
  ///Check if the given [method] is supported by the [defaultTargetPlatform] or a specific [platform].
  ///{@endtemplate}
