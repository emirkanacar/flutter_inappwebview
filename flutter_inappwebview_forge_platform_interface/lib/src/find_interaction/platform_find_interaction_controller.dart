...
///{@template flutter_inappwebview_forge_platform_interface.PlatformFindInteractionControllerCreationParams}
...
///{@endtemplate}
///
///{@macro flutter_inappwebview_forge_platform_interface.PlatformFindInteractionControllerCreationParams.supported_platforms}
@SupportedPlatforms(
  platforms: [
    AndroidPlatform(),
    IOSPlatform(),
...
class PlatformFindInteractionControllerCreationParams {
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformFindInteractionControllerCreationParams.onFindResultReceived}
  ...
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformFindInteractionControllerCreationParams.onFindResultReceived.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformFindInteractionControllerCreationParams.isClassSupported}
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformFindInteractionControllerCreationParams.isPropertySupported}
...
///{@template flutter_inappwebview_forge_platform_interface.PlatformFindInteractionController}
...
///{@endtemplate}
///
///{@macro flutter_inappwebview_forge_platform_interface.PlatformFindInteractionController.supported_platforms}
@SupportedPlatforms(
  platforms: [
    AndroidPlatform(),
    IOSPlatform(),
...
abstract class PlatformFindInteractionController extends PlatformInterface
  ...
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformFindInteractionControllerCreationParams.onFindResultReceived}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformFindInteractionControllerCreationParams.onFindResultReceived.supported_platforms}
  void Function(
    PlatformFindInteractionController controller,
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformFindInteractionController.findAll}
  ...
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformFindInteractionController.setFindOptions.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      WindowsPlatform(
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformFindInteractionController.findNext}
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformFindInteractionController.clearMatches}
  ///Clears the highlighting surrounding text matches created by [findAll].
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformFindInteractionController.clearMatches.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformFindInteractionController.setSearchText}
  ///Pre-populate the search text to be used.
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformFindInteractionController.setSearchText.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(),
      IOSPlatform(
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformFindInteractionController.getSearchText}
  ///Get the search text used.
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformFindInteractionController.getSearchText.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(),
      IOSPlatform(
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformFindInteractionController.isFindNavigatorVisible}
  ///A Boolean value that indicates when the find panel displays onscreen.
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformFindInteractionController.isFindNavigatorVisible.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      IOSPlatform(
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformFindInteractionController.updateResultCount}
  ///Updates the results the interface displays for the active search.
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformFindInteractionController.updateResultCount.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      IOSPlatform(
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformFindInteractionController.presentFindNavigator}
  ///Begins a search, displaying the find panel.
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformFindInteractionController.presentFindNavigator.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      IOSPlatform(
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformFindInteractionController.dismissFindNavigator}
  ///Dismisses the find panel, if present.
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformFindInteractionController.dismissFindNavigator.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      IOSPlatform(
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformFindInteractionController.getActiveFindSession}
  ///If there's a currently active find session, returns the active find session.
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformFindInteractionController.getActiveFindSession.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(),
      IOSPlatform(
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformFindInteractionController.dispose}
  ///Disposes the controller.
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformFindInteractionController.dispose.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(),
      IOSPlatform(),
  ...
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformFindInteractionControllerCreationParams.isClassSupported}
  bool isClassSupported({TargetPlatform? platform}) =>
      params.isClassSupported(platform: platform);

  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformFindInteractionControllerCreationParams.isPropertySupported}
  bool isPropertySupported(
    PlatformFindInteractionControllerCreationParamsProperty property, {
    TargetPlatform? platform,
  }) => params.isPropertySupported(property, platform: platform);

  ///{@template flutter_inappwebview_forge_platform_interface.PlatformFindInteractionController.isMethodSupported}
