...
extension _PlatformProcessGlobalConfigCreationParamsClassSupported
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformProcessGlobalConfigCreationParams.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- Android WebView
  ///
...
extension _PlatformProcessGlobalConfigClassSupported
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformProcessGlobalConfig.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
...
enum PlatformProcessGlobalConfigMethod {
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformProcessGlobalConfig.apply.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- Android WebView ([Official API - ProcessGlobalConfig.apply](https://developer.android.com/reference/androidx/webkit/ProcessGlobalConfig#apply(androidx.webkit.ProcessGlobalConfig)))
  ///
...
extension _ProcessGlobalConfigSettingsClassSupported
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.ProcessGlobalConfigSettings.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- Android WebView ([Official API - ProcessGlobalConfig.apply](https://developer.android.com/reference/androidx/webkit/ProcessGlobalConfig#apply(androidx.webkit.ProcessGlobalConfig)))
  ///
...
enum ProcessGlobalConfigSettingsProperty {
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.ProcessGlobalConfigSettings.dataDirectorySuffix.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- Android WebView:
  ///    - Available only if [WebViewFeature.STARTUP_FEATURE_SET_DATA_DIRECTORY_SUFFIX] feature is supported.
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.ProcessGlobalConfigSettings.directoryBasePaths.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- Android WebView:
  ///    - Available only if [WebViewFeature.STARTUP_FEATURE_SET_DIRECTORY_BASE_PATHS] feature is supported.
