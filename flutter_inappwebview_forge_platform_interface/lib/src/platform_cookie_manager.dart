...
///{@template flutter_inappwebview_forge_platform_interface.PlatformCookieManagerCreationParams}
...
///{@endtemplate}
///
///{@macro flutter_inappwebview_forge_platform_interface.PlatformCookieManagerCreationParams.supported_platforms}
@SupportedPlatforms(
  platforms: [
    AndroidPlatform(),
    IOSPlatform(),
...
class PlatformCookieManagerCreationParams {
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformCookieManagerCreationParams.webViewEnvironment}
  ///Used to create the [PlatformCookieManager] using the specified environment.
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformCookieManagerCreationParams.webViewEnvironment.supported_platforms}
  @SupportedPlatforms(platforms: [WindowsPlatform()])
  final PlatformWebViewEnvironment? webViewEnvironment;

  ///{@template flutter_inappwebview_forge_platform_interface.PlatformCookieManagerCreationParams.isClassSupported}
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformCookieManagerCreationParams.isPropertySupported}
...
///{@template flutter_inappwebview_forge_platform_interface.PlatformCookieManager}
///Class that implements a singleton object (shared instance) which manages the cookies used by WebView instances.
///{@endtemplate}
///
///{@macro flutter_inappwebview_forge_platform_interface.PlatformCookieManager.supported_platforms}
@SupportedPlatforms(
  platforms: [
    AndroidPlatform(
      note:
...
abstract class PlatformCookieManager extends PlatformInterface {
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformCookieManager.setCookie}
  ...
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformCookieManager.setCookie.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(
...
In this case, this method will return always `true`.""",
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformCookieManager.getCookies}
  ///Gets all the cookies for the given [url].
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformCookieManager.getCookies.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(
...
to get the cookies (session-only cookies and cookies with `isHttpOnly` enabled won't be found!).""",
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformCookieManager.getCookie}
  ///Gets a cookie by its [name] for the given [url].
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformCookieManager.getCookie.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(
        apiName: 'CookieManager.getCookie',
...
to get the cookie (session-only cookie and cookie with `isHttpOnly` enabled won't be found!).""",
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformCookieManager.deleteCookie}
  ...
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformCookieManager.deleteCookie.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(
        apiName: 'CookieManager.getCookie',
...
In this case, this method will return always `true`.""",
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformCookieManager.deleteCookies}
  ...
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformCookieManager.deleteCookies.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(
        apiName: 'CookieManager.getCookie',
...
In this case, this method will return always `true`.""",
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformCookieManager.deleteAllCookies}
  ///Removes all cookies.
  ///
  ///The return value indicates whether any cookies were removed.
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformCookieManager.deleteAllCookies.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformCookieManager.getAllCookies}
  ///Fetches all stored cookies.
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformCookieManager.getAllCookies.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      IOSPlatform(
        apiName: 'WKHTTPCookieStore.getAllCookies',
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformCookieManager.removeSessionCookies}
  ///Removes all session cookies, which are cookies without an expiration date.
  ///
  ///The return value indicates whether any cookies were removed.
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformCookieManager.removeSessionCookies.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformCookieManager.flush}
  ...
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformCookieManagerCreationParams.isPropertySupported}
  bool isPropertySupported(
    PlatformCookieManagerCreationParamsProperty property, {
    TargetPlatform? platform,
  }) => params.isPropertySupported(property, platform: platform);

  ///{@template flutter_inappwebview_forge_platform_interface.PlatformCookieManager.isMethodSupported}
