...
///{@template flutter_inappwebview_forge_platform_interface.PlatformTracingControllerCreationParams}
...
///{@endtemplate}
///
///{@macro flutter_inappwebview_forge_platform_interface.PlatformTracingControllerCreationParams.supported_platforms}
...
class PlatformTracingControllerCreationParams {
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformTracingControllerCreationParams.isClassSupported}
...
///{@template flutter_inappwebview_forge_platform_interface.PlatformTracingController}
...
///{@endtemplate}
///
///{@macro flutter_inappwebview_forge_platform_interface.PlatformTracingController.supported_platforms}
@SupportedPlatforms(
  platforms: [
    AndroidPlatform(
...
abstract class PlatformTracingController extends PlatformInterface {
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformTracingController.start}
  ...
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformTracingController.start.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformTracingController.stop}
  ...
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformTracingController.stop.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformTracingController.isTracing}
  ///Returns whether the WebView framework is tracing.
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformTracingController.isTracing.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(
  ...
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformTracingControllerCreationParams.isClassSupported}
  bool isClassSupported({TargetPlatform? platform}) =>
      params.isClassSupported(platform: platform);

  ///{@template flutter_inappwebview_forge_platform_interface.PlatformTracingController.isMethodSupported}
...
///{@template flutter_inappwebview_forge_platform_interface.TracingSettings}
///Class that represents the settings used to configure the [PlatformTracingController].
///{@endtemplate}
///
///{@macro flutter_inappwebview_forge_platform_interface.TracingSettings.supported_platforms}
@SupportedPlatforms(
  platforms: [
    AndroidPlatform(
...
class TracingSettings_ {
  ...
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.TracingSettings.tracingMode.supported_platforms}
  @SupportedPlatforms(platforms: [AndroidPlatform()])
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.TracingSettings.isClassSupported}
  ///Check if the current class is supported by the [defaultTargetPlatform] or a specific [platform].
  ///{@endtemplate}
  static bool isClassSupported({TargetPlatform? platform}) =>
      _TracingSettingsClassSupported.isClassSupported(platform: platform);

  ///{@template flutter_inappwebview_forge_platform_interface.TracingSettings.isPropertySupported}
  ///Check if the current class is supported by the [defaultTargetPlatform] or a specific [platform].
  ///{@endtemplate}
