...
///{@template flutter_inappwebview_forge_platform_interface.PlatformInAppWebViewWidgetCreationParams}
...
///{@endtemplate}
///
///{@macro flutter_inappwebview_forge_platform_interface.PlatformInAppWebViewWidgetCreationParams.supported_platforms}
@SupportedPlatforms(
  platforms: [
    AndroidPlatform(),
    IOSPlatform(),
...
class PlatformInAppWebViewWidgetCreationParams
  ...
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformInAppWebViewWidgetCreationParams}
  ///
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformInAppWebViewWidgetCreationParams.headlessWebView}
  ///The [PlatformHeadlessInAppWebView] to use to initialize this widget.
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformInAppWebViewWidgetCreationParams.keepAlive.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(),
      IOSPlatform(),
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformInAppWebViewWidgetCreationParams.keepAlive}
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformInAppWebViewWidgetCreationParams.webViewEnvironment}
  ///Used to prevent gesture delay on iOS caused by Flutter's gestures handling
  ///between native/platform views.
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformInAppWebViewWidgetCreationParams.webViewEnvironment.supported_platforms}
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformInAppWebViewWidgetCreationParams.isClassSupported}
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformInAppWebViewWidgetCreationParams.isPropertySupported}
...
///
///{@template flutter_inappwebview_forge_platform_interface.PlatformInAppWebViewWidget}
...
abstract class PlatformInAppWebViewWidget extends PlatformInterface
  ...
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformInAppWebViewWidgetCreationParams.isClassSupported}
  bool isClassSupported({TargetPlatform? platform}) =>
      params.isClassSupported(platform: platform);

  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformInAppWebViewWidgetCreationParams.isPropertySupported}
  bool isPropertySupported(dynamic property, {TargetPlatform? platform}) =>
