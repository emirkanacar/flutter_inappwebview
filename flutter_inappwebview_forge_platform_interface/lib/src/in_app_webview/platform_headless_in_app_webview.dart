...
///{@template flutter_inappwebview_forge_platform_interface.PlatformHeadlessInAppWebViewCreationParams}
...
///{@endtemplate}
///
///{@macro flutter_inappwebview_forge_platform_interface.PlatformHeadlessInAppWebViewCreationParams.supported_platforms}
@SupportedPlatforms(
  platforms: [
    AndroidPlatform(),
    IOSPlatform(),
...
class PlatformHeadlessInAppWebViewCreationParams
  ...
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformHeadlessInAppWebViewCreationParams}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformHeadlessInAppWebViewCreationParams.supported_platforms}
  const PlatformHeadlessInAppWebViewCreationParams({
    ...
    super.onVisualStateReady,
    super.onWritingToolsActiveChanged,
    super.onWebViewNavigation,
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformHeadlessInAppWebViewCreationParams.initialSize}
  ...
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformHeadlessInAppWebViewCreationParams.initialSize.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(
        note:
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformHeadlessInAppWebViewCreationParams.webViewEnvironment}
  ///Used to create the [PlatformHeadlessInAppWebView] using the specified environment.
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformHeadlessInAppWebViewCreationParams.webViewEnvironment.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      WindowsPlatform(),
      LinuxPlatform(
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformHeadlessInAppWebViewCreationParams.isClassSupported}
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformHeadlessInAppWebViewCreationParams.isPropertySupported}
...
///{@template flutter_inappwebview_forge_platform_interface.PlatformHeadlessInAppWebView}
...
///{@endtemplate}
///
///{@macro flutter_inappwebview_forge_platform_interface.PlatformHeadlessInAppWebView.supported_platforms}
@SupportedPlatforms(
  platforms: [
    AndroidPlatform(),
    IOSPlatform(),
...
abstract class PlatformHeadlessInAppWebView extends PlatformInterface
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformHeadlessInAppWebView.id}
  ///View ID.
  ///{@endtemplate}
  String get id =>
      throw UnimplementedError('id is not implemented on the current platform');

  ///{@template flutter_inappwebview_forge_platform_interface.PlatformHeadlessInAppWebView.webViewController}
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformHeadlessInAppWebView.run}
  ///Runs the headless WebView.
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformHeadlessInAppWebView.run.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(),
      IOSPlatform(),
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformHeadlessInAppWebView.isRunning}
  ///Indicates if the headless WebView is running or not.
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformHeadlessInAppWebView.isRunning.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(),
      IOSPlatform(),
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformHeadlessInAppWebView.setSize}
  ...
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformHeadlessInAppWebView.setSize.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(
        note:
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformHeadlessInAppWebView.getSize}
  ...
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformHeadlessInAppWebView.getSize.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(),
      IOSPlatform(),
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformHeadlessInAppWebView.dispose}
  ///Disposes the headless WebView.
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformHeadlessInAppWebView.dispose.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(),
      IOSPlatform(),
  ...
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformHeadlessInAppWebViewCreationParams.isClassSupported}
  bool isClassSupported({TargetPlatform? platform}) =>
      params.isClassSupported(platform: platform);

  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformHeadlessInAppWebViewCreationParams.isPropertySupported}
  bool isPropertySupported(dynamic property, {TargetPlatform? platform}) =>
      params.isPropertySupported(property, platform: platform);

  ///{@template flutter_inappwebview_forge_platform_interface.PlatformHeadlessInAppWebView.isMethodSupported}
