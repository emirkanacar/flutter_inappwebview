...
extension _PlatformInAppWebViewWidgetCreationParamsClassSupported
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformInAppWebViewWidgetCreationParams.supported_platforms}
  ///
...
enum PlatformInAppWebViewWidgetCreationParamsProperty {
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformInAppWebViewWidgetCreationParams.headlessWebView.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- Android WebView
  ///- iOS WKWebView
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformInAppWebViewWidgetCreationParams.keepAlive.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- Android WebView
  ///- iOS WKWebView
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformInAppWebViewWidgetCreationParams.preventGestureDelay.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- iOS WKWebView
  ///
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformInAppWebViewWidgetCreationParams.webViewEnvironment.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- Windows WebView2
