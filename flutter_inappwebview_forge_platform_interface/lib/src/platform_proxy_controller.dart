...
///{@template flutter_inappwebview_forge_platform_interface.PlatformProxyControllerCreationParams}
...
///{@endtemplate}
///
///{@macro flutter_inappwebview_forge_platform_interface.PlatformProxyControllerCreationParams.supported_platforms}
@SupportedPlatforms(
  platforms: [
    AndroidPlatform(),
    IOSPlatform(),
...
class PlatformProxyControllerCreationParams {
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformProxyControllerCreationParams.isClassSupported}
...
///{@template flutter_inappwebview_forge_platform_interface.PlatformProxyController}
...
///{@endtemplate}
///
///{@macro flutter_inappwebview_forge_platform_interface.PlatformProxyController.supported_platforms}
@SupportedPlatforms(
  platforms: [
    AndroidPlatform(
...
abstract class PlatformProxyController extends PlatformInterface {
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformProxyController.setProxyOverride}
  ...
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformProxyController.setProxyOverride.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformProxyController.clearProxyOverride}
  ...
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformProxyController.clearProxyOverride.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(
  ...
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformProxyControllerCreationParams.isClassSupported}
  bool isClassSupported({TargetPlatform? platform}) =>
      params.isClassSupported(platform: platform);

  ///{@template flutter_inappwebview_forge_platform_interface.PlatformProxyController.isMethodSupported}
