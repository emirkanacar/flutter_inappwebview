...
///{@template flutter_inappwebview_forge_platform_interface.ProxySettings}
///Class that represents the settings used to configure the [PlatformProxyController].
///{@endtemplate}
///
///{@macro flutter_inappwebview_forge_platform_interface.ProxySettings.supported_platforms}
///
...
class ProxySettings {
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.ProxySettings.isClassSupported}
  ///Check if the current class is supported by the [defaultTargetPlatform] or a specific [platform].
  ///{@endtemplate}
  static bool isClassSupported({TargetPlatform? platform}) =>
      _ProxySettingsClassSupported.isClassSupported(platform: platform);

  ///{@template flutter_inappwebview_forge_platform_interface.ProxySettings.isPropertySupported}
  ///Check if the current class is supported by the [defaultTargetPlatform] or a specific [platform].
  ///{@endtemplate}
...
extension _PlatformProxyControllerCreationParamsClassSupported
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformProxyControllerCreationParams.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- Android WebView
  ///- iOS WKWebView
...
extension _PlatformProxyControllerClassSupported on PlatformProxyController {
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformProxyController.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
...
enum PlatformProxyControllerMethod {
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformProxyController.clearProxyOverride.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformProxyController.setProxyOverride.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
...
extension _ProxySettingsClassSupported on ProxySettings {
  ///{@template flutter_inappwebview_forge_platform_interface.ProxySettings.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- Android WebView ([Official API - ProxyConfig](https://developer.android.com/reference/androidx/webkit/ProxyConfig))
  ///- iOS WKWebView 17.0+ ([Official API - ProxyConfiguration](https://developer.apple.com/documentation/network/proxyconfiguration))
...
enum ProxySettingsProperty {
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.ProxySettings.bypassRules.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- Android WebView
  ///- Linux WPE WebKit ([Official API - webkit_network_proxy_settings_new (ignore_hosts)](https://wpewebkit.org/reference/stable/wpe-webkit-2.0/ctor.NetworkProxySettings.new.html)):
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.ProxySettings.bypassSimpleHostnames.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- Android WebView
  ///
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.ProxySettings.directs.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- Android WebView
  ///
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.ProxySettings.proxyRules.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- Android WebView
  ///- iOS WKWebView
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.ProxySettings.removeImplicitRules.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- Android WebView
  ///
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.ProxySettings.reverseBypassEnabled.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- Android WebView
  ///
