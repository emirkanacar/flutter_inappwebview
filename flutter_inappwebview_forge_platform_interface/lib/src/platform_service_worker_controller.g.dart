...
extension _PlatformServiceWorkerControllerCreationParamsClassSupported
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformServiceWorkerControllerCreationParams.supported_platforms}
  ///
...
extension _PlatformServiceWorkerControllerClassSupported
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformServiceWorkerController.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
...
enum PlatformServiceWorkerControllerMethod {
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformServiceWorkerController.getAllowContentAccess.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformServiceWorkerController.getAllowFileAccess.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformServiceWorkerController.getBlockNetworkLoads.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformServiceWorkerController.getCacheMode.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformServiceWorkerController.setAllowContentAccess.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformServiceWorkerController.setAllowFileAccess.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformServiceWorkerController.setBlockNetworkLoads.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformServiceWorkerController.setCacheMode.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformServiceWorkerController.setServiceWorkerClient.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
...
extension _ServiceWorkerClientClassSupported on ServiceWorkerClient {
  ///{@template flutter_inappwebview_forge_platform_interface.ServiceWorkerClient.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
...
enum ServiceWorkerClientProperty {
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.ServiceWorkerClient.shouldInterceptRequest.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
