...
enum PullToRefreshSettingsProperty {
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.PullToRefreshSettings.backgroundColor.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- Android WebView
  ///- iOS WKWebView
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.PullToRefreshSettings.color.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- Android WebView
  ///- iOS WKWebView
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.PullToRefreshSettings.distanceToTriggerSync.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- Android WebView
  ///
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.PullToRefreshSettings.enabled.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- Android WebView
  ///- iOS WKWebView
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.PullToRefreshSettings.size.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- Android WebView
  ///
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.PullToRefreshSettings.slingshotDistance.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- Android WebView
  ///
