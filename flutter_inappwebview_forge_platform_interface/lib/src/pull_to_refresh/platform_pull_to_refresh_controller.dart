...
///{@template flutter_inappwebview_forge_platform_interface.PlatformPullToRefreshControllerCreationParams}
...
class PlatformPullToRefreshControllerCreationParams {
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformPullToRefreshControllerCreationParams.options}
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformPullToRefreshControllerCreationParams.settings}
  /// Initial settings.
  ///{@endtemplate}
  ///
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformPullToRefreshControllerCreationParams.isPropertySupported}
...
///{@template flutter_inappwebview_forge_platform_interface.PlatformPullToRefreshController}
...
///{@endtemplate}
///
///{@macro flutter_inappwebview_forge_platform_interface.PlatformPullToRefreshController.supported_platforms}
@SupportedPlatforms(
  platforms: [
    AndroidPlatform(
      note:
...
abstract class PlatformPullToRefreshController extends PlatformInterface
  ...
  factory PlatformPullToRefreshController.static() {
    assert(
      InAppWebViewPlatform.instance != null,
      'A platform implementation for `flutter_inappwebview_forge` has not been set. Please '
      'ensure that an implementation of `flutter_inappwebview_forge` has been set to '
      '`InAppWebViewPlatform.instance` before use. For unit testing, '
      '`InAppWebViewPlatform.instance` can be set with your own test implementation.',
    );
  ...
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformPullToRefreshControllerCreationParams.options}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformPullToRefreshControllerCreationParams.options.supported_platforms}
  @Deprecated("Use settings instead")
  PullToRefreshOptions get options => params.options;

  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformPullToRefreshControllerCreationParams.settings}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformPullToRefreshControllerCreationParams.settings.supported_platforms}
  PullToRefreshSettings get settings => params.settings;

  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformPullToRefreshControllerCreationParams.onRefresh}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformPullToRefreshControllerCreationParams.onRefresh.supported_platforms}
  void Function()? get onRefresh => params.onRefresh;

  ///{@template flutter_inappwebview_forge_platform_interface.PlatformPullToRefreshController.setEnabled}
  ///Sets whether the pull-to-refresh feature is enabled or not.
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformPullToRefreshController.setEnabled.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformPullToRefreshController.isEnabled}
  ///Returns `true` is pull-to-refresh feature is enabled, otherwise `false`.
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformPullToRefreshController.isEnabled.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformPullToRefreshController.beginRefreshing}
  ...
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformPullToRefreshController.beginRefreshing.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformPullToRefreshController.endRefreshing}
  ...
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformPullToRefreshController.endRefreshing.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(
        apiName: 'SwipeRefreshLayout.setRefreshing',
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformPullToRefreshController.isRefreshing}
  ///Returns whether a refresh operation has been triggered and is in progress.
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformPullToRefreshController.isRefreshing.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformPullToRefreshController.setColor}
  ///Sets the color of the refresh control.
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformPullToRefreshController.setColor.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformPullToRefreshController.setBackgroundColor}
  ///Sets the background color of the refresh control.
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformPullToRefreshController.setBackgroundColor.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformPullToRefreshController.setDistanceToTriggerSync}
  ///Set the distance to trigger a sync in dips.
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformPullToRefreshController.setDistanceToTriggerSync.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformPullToRefreshController.setSlingshotDistance}
  ///Sets the distance that the refresh indicator can be pulled beyond its resting position during a swipe gesture.
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformPullToRefreshController.setSlingshotDistance.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformPullToRefreshController.getDefaultSlingshotDistance}
  ///Gets the default distance that the refresh indicator can be pulled beyond its resting position during a swipe gesture.
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformPullToRefreshController.getDefaultSlingshotDistance.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformPullToRefreshController.setSize}
  ///Use [setIndicatorSize] instead.
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformPullToRefreshController.setSize.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformPullToRefreshController.setIndicatorSize}
  ///Sets the size of the refresh indicator. One of [PullToRefreshSize.DEFAULT], or [PullToRefreshSize.LARGE].
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformPullToRefreshController.setIndicatorSize.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(
        apiName: 'SwipeRefreshLayout.setSize',
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformPullToRefreshController.setAttributedTitle}
  ///Use [setStyledTitle] instead.
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformPullToRefreshController.setAttributedTitle.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      IOSPlatform(
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformPullToRefreshController.setStyledTitle}
  ///Sets the styled title text to display in the refresh control.
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformPullToRefreshController.setStyledTitle.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      IOSPlatform(
        apiName: 'UIRefreshControl.attributedTitle',
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformPullToRefreshController.dispose}
  ...
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformPullToRefreshControllerCreationParams.isClassSupported}
  bool isClassSupported({TargetPlatform? platform}) =>
      _PlatformPullToRefreshControllerClassSupported.isClassSupported(
        platform: platform,
      );

  ///{@template flutter_inappwebview_forge_platform_interface.PlatformPullToRefreshController.isPropertySupported}
  ///Check if the given [property] is supported by the [defaultTargetPlatform] or a specific [platform].
  ///{@endtemplate}
  bool isPropertySupported(
    PlatformPullToRefreshControllerCreationParamsProperty property, {
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformPullToRefreshController.isMethodSupported}
