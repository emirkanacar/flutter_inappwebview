...
///{@template flutter_inappwebview_forge_platform_interface.PlatformHttpAuthCredentialDatabaseCreationParams}
...
///{@endtemplate}
///
///{@macro flutter_inappwebview_forge_platform_interface.PlatformHttpAuthCredentialDatabaseCreationParams.supported_platforms}
@SupportedPlatforms(
  platforms: [
    AndroidPlatform(),
    IOSPlatform(),
...
class PlatformHttpAuthCredentialDatabaseCreationParams {
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformHttpAuthCredentialDatabaseCreationParams.isClassSupported}
...
///{@template flutter_inappwebview_forge_platform_interface.PlatformHttpAuthCredentialDatabase}
///Class that implements a singleton object (shared instance) which manages the shared HTTP auth credentials cache.
///{@endtemplate}
///
///{@macro flutter_inappwebview_forge_platform_interface.PlatformHttpAuthCredentialDatabase.supported_platforms}
@SupportedPlatforms(
  platforms: [
    AndroidPlatform(
      note:
...
abstract class PlatformHttpAuthCredentialDatabase extends PlatformInterface {
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformHttpAuthCredentialDatabase.getAllAuthCredentials}
  ...
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformHttpAuthCredentialDatabase.getAllAuthCredentials.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(),
      IOSPlatform(
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformHttpAuthCredentialDatabase.getHttpAuthCredentials}
  ///Gets all the HTTP auth credentials saved for that [protectionSpace].
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformHttpAuthCredentialDatabase.getHttpAuthCredentials.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(),
      IOSPlatform(),
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformHttpAuthCredentialDatabase.setHttpAuthCredential}
  ///Saves an HTTP auth [credential] for that [protectionSpace].
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformHttpAuthCredentialDatabase.setHttpAuthCredential.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(),
      IOSPlatform(
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformHttpAuthCredentialDatabase.removeHttpAuthCredential}
  ///Removes an HTTP auth [credential] for that [protectionSpace].
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformHttpAuthCredentialDatabase.removeHttpAuthCredential.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(),
      IOSPlatform(
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformHttpAuthCredentialDatabase.removeHttpAuthCredentials}
  ///Removes all the HTTP auth credentials saved for that [protectionSpace].
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformHttpAuthCredentialDatabase.removeHttpAuthCredentials.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(),
      IOSPlatform(),
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformHttpAuthCredentialDatabase.clearAllAuthCredentials}
  ///Removes all the HTTP auth credentials saved in the database.
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformHttpAuthCredentialDatabase.clearAllAuthCredentials.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(),
      IOSPlatform(),
  ...
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformHttpAuthCredentialDatabaseCreationParams.isClassSupported}
  bool isClassSupported({TargetPlatform? platform}) =>
      params.isClassSupported(platform: platform);

  ///{@template flutter_inappwebview_forge_platform_interface.PlatformHttpAuthCredentialDatabase.isMethodSupported}
