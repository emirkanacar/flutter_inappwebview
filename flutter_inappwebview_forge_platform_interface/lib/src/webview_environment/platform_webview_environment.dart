...
class PlatformWebViewEnvironmentCreationParams {
  ...
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebViewEnvironmentCreationParams.settings.supported_platforms}
  @SupportedPlatforms(platforms: [WindowsPlatform()])
  final WebViewEnvironmentSettings? settings;

  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebViewEnvironmentCreationParams.isClassSupported}
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebViewEnvironmentCreationParams.isPropertySupported}
...
///
///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebViewEnvironment.supported_platforms}
@SupportedPlatforms(platforms: [WindowsPlatform(), LinuxPlatform()])
abstract class PlatformWebViewEnvironment extends PlatformInterface
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebViewEnvironment.id}
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebViewEnvironment.isInterfaceSupported}
  ...
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebViewEnvironment.isInterfaceSupported.supported_platforms}
  @SupportedPlatforms(platforms: [WindowsPlatform()])
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebViewEnvironment.getProcessInfos}
  ///Returns a list of all process using same user data folder except for crashpad process.
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebViewEnvironment.getProcessInfos.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      WindowsPlatform(
  ...
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebViewEnvironment.getFailureReportFolderPath.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      WindowsPlatform(
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebViewEnvironment.create}
  ...
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebViewEnvironment.create.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      WindowsPlatform(
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebViewEnvironment.getAvailableVersion}
  ...
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebViewEnvironment.getAvailableVersion.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      WindowsPlatform(
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebViewEnvironment.compareBrowserVersions}
  ...
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebViewEnvironment.compareBrowserVersions.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      WindowsPlatform(
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebViewEnvironment.onNewBrowserVersionAvailable}
  ...
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebViewEnvironment.onNewBrowserVersionAvailable.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      WindowsPlatform(
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebViewEnvironment.onBrowserProcessExited}
  ...
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebViewEnvironment.onBrowserProcessExited.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      WindowsPlatform(
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebViewEnvironment.onProcessInfosChanged}
  ///Event fired with a list of all process using same user data folder except for crashpad process.
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebViewEnvironment.onProcessInfosChanged.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      WindowsPlatform(
        available: '1.0.1108.44+',
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebViewEnvironment.isSpellCheckingEnabled}
  ///Returns whether spell checking is enabled for this WebContext.
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebViewEnvironment.isSpellCheckingEnabled.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      LinuxPlatform(
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebViewEnvironment.getSpellCheckingLanguages}
  ...
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebViewEnvironment.getSpellCheckingLanguages.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      LinuxPlatform(
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebViewEnvironment.getCacheModel}
  ///Returns the current cache model for this WebContext.
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebViewEnvironment.getCacheModel.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      LinuxPlatform(
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebViewEnvironment.isAutomationAllowed}
  ///Returns whether automation is allowed for this WebContext.
  ///
  ///When automation is allowed, web pages can use the WebDriver API.
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebViewEnvironment.isAutomationAllowed.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      LinuxPlatform(
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebViewEnvironment.dispose}
  ///Disposes the WebView Environment reference.
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformWebViewEnvironment.dispose.supported_platforms}
  @SupportedPlatforms(platforms: [WindowsPlatform(), LinuxPlatform()])
  Future<void> dispose() {
    throw UnimplementedError(
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebViewEnvironment.isClassSupported}
  ///Check if the current class is supported by the [defaultTargetPlatform] or a specific [platform].
  ///{@endtemplate}
  bool isClassSupported({TargetPlatform? platform}) =>
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebViewEnvironment.isPropertySupported}
  ///Check if the given [property] is supported by the [defaultTargetPlatform] or a specific [platform].
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebViewEnvironment.isMethodSupported}
