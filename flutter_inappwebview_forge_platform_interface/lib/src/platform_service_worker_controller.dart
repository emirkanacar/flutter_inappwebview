...
///{@template flutter_inappwebview_forge_platform_interface.PlatformServiceWorkerControllerCreationParams}
...
///{@endtemplate}
///
///{@macro flutter_inappwebview_forge_platform_interface.PlatformServiceWorkerControllerCreationParams.supported_platforms}
...
class PlatformServiceWorkerControllerCreationParams {
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformServiceWorkerControllerCreationParams.isClassSupported}
...
///{@template flutter_inappwebview_forge_platform_interface.PlatformServiceWorkerController}
...
abstract class PlatformServiceWorkerController extends PlatformInterface {
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformServiceWorkerController.serviceWorkerClient}
  ///Service Worker client.
  ///{@endtemplate}
  ServiceWorkerClient? get serviceWorkerClient;

  ///{@template flutter_inappwebview_forge_platform_interface.PlatformServiceWorkerController.setServiceWorkerClient}
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformServiceWorkerController.getAllowContentAccess}
  ...
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformServiceWorkerController.getAllowContentAccess.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformServiceWorkerController.getAllowFileAccess}
  ...
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformServiceWorkerController.getAllowFileAccess.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformServiceWorkerController.getBlockNetworkLoads}
  ...
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformServiceWorkerController.getBlockNetworkLoads.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformServiceWorkerController.getCacheMode}
  ...
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformServiceWorkerController.getCacheMode.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformServiceWorkerController.setAllowContentAccess}
  ///Enables or disables content URL access from Service Workers.
  ///This method should only be called if [WebViewFeature.isFeatureSupported] returns `true` for [WebViewFeature.SERVICE_WORKER_CONTENT_ACCESS].
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformServiceWorkerController.setAllowContentAccess.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformServiceWorkerController.setAllowFileAccess}
  ///Enables or disables file access within Service Workers.
  ///This method should only be called if [WebViewFeature.isFeatureSupported] returns `true` for [WebViewFeature.SERVICE_WORKER_FILE_ACCESS].
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformServiceWorkerController.setAllowFileAccess.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformServiceWorkerController.setBlockNetworkLoads}
  ///Sets whether Service Workers should not load resources from the network.
  ///This method should only be called if [WebViewFeature.isFeatureSupported] returns `true` for [WebViewFeature.SERVICE_WORKER_BLOCK_NETWORK_LOADS].
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformServiceWorkerController.setBlockNetworkLoads.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformServiceWorkerController.setCacheMode}
  ///Overrides the way the cache is used.
  ///This method should only be called if [WebViewFeature.isFeatureSupported] returns `true` for [WebViewFeature.SERVICE_WORKER_CACHE_MODE].
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformServiceWorkerController.setCacheMode.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(
  ...
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformServiceWorkerControllerCreationParams.isClassSupported}
  bool isClassSupported({TargetPlatform? platform}) =>
      params.isClassSupported(platform: platform);

  ///{@template flutter_inappwebview_forge_platform_interface.PlatformServiceWorkerController.isMethodSupported}
...
///{@template flutter_inappwebview_forge_platform_interface.ServiceWorkerClient}
///Class used by clients to capture Service Worker related callbacks.
///{@endtemplate}
///
///{@macro flutter_inappwebview_forge_platform_interface.ServiceWorkerClient.supported_platforms}
@SupportedPlatforms(
  platforms: [
    AndroidPlatform(
...
class ServiceWorkerClient {
  ///{@template flutter_inappwebview_forge_platform_interface.ServiceWorkerClient.shouldInterceptRequest}
  ...
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.ServiceWorkerClient.shouldInterceptRequest.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.ServiceWorkerClient.isClassSupported}
  ///Check if the current class is supported by the [defaultTargetPlatform] or a specific [platform].
  ///{@endtemplate}
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.ServiceWorkerClient.isPropertySupported}
  ///Check if the given [method] is supported by the [defaultTargetPlatform] or a specific [platform].
  ///{@endtemplate}
