...
///{@template flutter_inappwebview_forge_platform_interface.PlatformProcessGlobalConfigCreationParams}
...
///{@endtemplate}
///
///{@macro flutter_inappwebview_forge_platform_interface.PlatformProcessGlobalConfigCreationParams.supported_platforms}
...
class PlatformProcessGlobalConfigCreationParams {
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformProcessGlobalConfigCreationParams.isClassSupported}
...
///{@template flutter_inappwebview_forge_platform_interface.PlatformProcessGlobalConfig}
...
///{@endtemplate}
///
///{@macro flutter_inappwebview_forge_platform_interface.PlatformProcessGlobalConfig.supported_platforms}
@SupportedPlatforms(
  platforms: [
    AndroidPlatform(
...
abstract class PlatformProcessGlobalConfig extends PlatformInterface {
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformProcessGlobalConfig.apply}
  ...
  ///{@endtemplate}
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformProcessGlobalConfig.apply.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(
  ...
  ///{@macro flutter_inappwebview_forge_platform_interface.PlatformProcessGlobalConfigCreationParams.isClassSupported}
  bool isClassSupported({TargetPlatform? platform}) =>
      params.isClassSupported(platform: platform);

  ///{@template flutter_inappwebview_forge_platform_interface.PlatformProcessGlobalConfig.isMethodSupported}
...
///{@template flutter_inappwebview_forge_platform_interface.ProcessGlobalConfigSettings}
///Class that represents the settings used to configure the [PlatformProcessGlobalConfig].
///{@endtemplate}
///
///{@macro flutter_inappwebview_forge_platform_interface.ProcessGlobalConfigSettings.supported_platforms}
@SupportedPlatforms(
  platforms: [
    AndroidPlatform(
      apiName: 'ProcessGlobalConfig.apply',
...
class ProcessGlobalConfigSettings_ {
  ...
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.ProcessGlobalConfigSettings.dataDirectorySuffix.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(
        note:
  ...
  ///
  ///{@macro flutter_inappwebview_forge_platform_interface.ProcessGlobalConfigSettings.directoryBasePaths.supported_platforms}
  @SupportedPlatforms(
    platforms: [
      AndroidPlatform(
        note:
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.ProcessGlobalConfigSettings.isPropertySupported}
  ///Check if the current class is supported by the [defaultTargetPlatform] or a specific [platform].
  ///{@endtemplate}
