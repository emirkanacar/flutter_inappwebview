...
extension _PlatformWebViewFeatureCreationParamsClassSupported
  ...
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebViewFeatureCreationParams.supported_platforms}
  ///
...
extension _PlatformWebViewFeatureClassSupported on PlatformWebViewFeature {
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebViewFeature.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- Android WebView
  ///
...
enum PlatformWebViewFeatureMethod {
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebViewFeature.isFeatureSupported.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
  ...
  ///
  ///{@template flutter_inappwebview_forge_platform_interface.PlatformWebViewFeature.isStartupFeatureSupported.supported_platforms}
  ///
  ///**Officially Supported Platforms/Implementations**:
