...
- iOS support starts at iOS 15.0. macOS starts at 10.14. Android declares `minSdkVersion 24` (AndroidX WebKit `1.16.0`); older API 19–23 hosts must stay on 2.1.76 / Android 1.0.55.
